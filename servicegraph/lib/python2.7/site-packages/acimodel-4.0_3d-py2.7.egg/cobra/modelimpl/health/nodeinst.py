...
class NodeInst(Mo):
    """
    The health score instance calculated on a node and reported to appliance.

    """

    meta = ClassMeta("cobra.model.health.NodeInst")

    meta.moClassName = "healthNodeInst"
    meta.rnFormat = "nodehealth-%(nodeId)s"
    ...
    prop = PropMeta("str", "isExisting", "isExisting", 1494, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 1496, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "podId", "podId", 1495, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 255)]
    ...
    prop = PropMeta("str", "weight", "weight", 1497, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
