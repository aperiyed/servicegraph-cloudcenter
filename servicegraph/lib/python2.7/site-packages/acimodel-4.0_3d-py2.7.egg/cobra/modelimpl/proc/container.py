...
class Container(Mo):
    ...
    meta = ClassMeta("cobra.model.proc.Container")

    meta.moClassName = "procContainer"
    meta.rnFormat = "cntr-%(id)s"
    ...
    meta.childClasses.add("cobra.model.proc.App")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.proc.App", "app-"))
    ...
    prop = PropMeta("str", "containerName", "containerName", 30315, PropCategory.REGULAR)
    prop.label = "Container Name"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("containerName", prop)

    prop = PropMeta("str", "cpuPct", "cpuPct", 30318, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "id", "id", 30316, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "memPct", "memPct", 30319, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 30373, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "processId", "processId", 30317, PropCategory.REGULAR)
    prop.label = "Container Process ID"
    prop.isOper = True
