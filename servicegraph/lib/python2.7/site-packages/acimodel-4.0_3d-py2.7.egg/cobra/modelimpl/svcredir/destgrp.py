...
class DestGrp(Mo):
    ...
    prop._addConstant("svcredir:DestGrphashProfOption_failed_flag", None, 2)
    prop._addConstant("svcredir:DestGrpid_failed_flag", None, 4)
    prop._addConstant("svcredir:DestGrplcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("svcredir:DestGrplocationPBREnabled_failed_flag", None, 8)
    prop._addConstant("svcredir:DestGrpmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("svcredir:DestGrpmonPolDn_failed_flag", None, 16)
    prop._addConstant("svcredir:DestGrpredirPolKey_failed_flag", None, 128)
    prop._addConstant("svcredir:DestGrpresilientHashEnabled_failed_flag", None, 256)
    prop._addConstant("svcredir:DestGrpsortByName_failed_flag", None, 512)
    prop._addConstant("svcredir:DestGrpthresholdDownAction_failed_flag", None, 8192)
    prop._addConstant("svcredir:DestGrpthresholdEnabled_failed_flag", None, 16384)
    prop._addConstant("svcredir:DestGrpthresholdHigh_failed_flag", None, 32768)
    prop._addConstant("svcredir:DestGrpthresholdLow_failed_flag", None, 65536)
    prop._addConstant("svcredir:DestGrptrackingEnabled_failed_flag", None, 131072)
