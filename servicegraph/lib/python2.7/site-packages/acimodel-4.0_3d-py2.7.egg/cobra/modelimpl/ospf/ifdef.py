...
class IfDef(Mo):
    ...
    meta = ClassMeta("cobra.model.ospf.IfDef")

    meta.moClassName = "ospfIfDef"
    ...
    meta.childClasses.add("cobra.model.ospf.RsIfDefToOspfIf")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.ospf.RsIfDefToOspfv3If")
    meta.childClasses.add("cobra.model.ospf.AuthKeyDef")

    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.RsIfDefToOspfv3If", "rsIfDefToOspfv3If"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.RsIfDefToOspfIf", "rsIfDefToOspfIf"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.AuthKeyDef", "ospfAuthKeyDef"))
    ...
    prop = PropMeta("str", "cost", "cost", 1116, PropCategory.REGULAR)
    prop.label = "Cost"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 65535)]
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 1110, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "deadIntvl", "deadIntvl", 1113, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "helloIntvl", "helloIntvl", 1112, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nwT", "nwT", 1111, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pfxSuppress", "pfxSuppress", 23137, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "prio", "prio", 1115, PropCategory.REGULAR)
    prop.label = "Priority"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 255)]
    ...
    prop = PropMeta("str", "rexmitIntvl", "rexmitIntvl", 1114, PropCategory.REGULAR)
    prop.label = "Dead Retransmit"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    prop.defaultValue = 5
    ...
    prop = PropMeta("str", "xmitDelay", "xmitDelay", 1117, PropCategory.REGULAR)
