...
# ##################################################
class RsSpanSrcToL3OutAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.span.RsSpanSrcToL3OutAtt", "cobra.model.l3.If")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsSpanSrcToL3OutAtt"
    meta.rnFormat = "rsspanSrcToL3OutAtt"
    ...
    prop = PropMeta("str", "id", "id", 37033, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 37099, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "operSt", "operSt", 37034, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 37035, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 3
    ...
    prop = PropMeta("str", "spanCfgFailedBmp", "spanCfgFailedBmp", 37046, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("span:RsSpanSrcToL3OutAttforceResolve_failed_flag", None, 4)
    prop._addConstant("span:RsSpanSrcToL3OutAttid_failed_flag", None, 128)
    prop._addConstant("span:RsSpanSrcToL3OutAttlcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("span:RsSpanSrcToL3OutAttmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("span:RsSpanSrcToL3OutAttmonPolDn_failed_flag", None, 256)
    prop._addConstant("span:RsSpanSrcToL3OutAttrType_failed_flag", None, 8)
    prop._addConstant("span:RsSpanSrcToL3OutAttstateQual_failed_flag", None, 32)
    prop._addConstant("span:RsSpanSrcToL3OutAttstate_failed_flag", None, 16)
    prop._addConstant("span:RsSpanSrcToL3OutAtttCl_failed_flag", None, 1)
    prop._addConstant("span:RsSpanSrcToL3OutAtttDn_failed_flag", None, 2)
    prop._addConstant("span:RsSpanSrcToL3OutAtttSKey_failed_flag", None, 16384)
    prop._addConstant("span:RsSpanSrcToL3OutAtttType_failed_flag", None, 64)
    meta.props.add("spanCfgFailedBmp", prop)

    prop = PropMeta("str", "spanCfgFailedTs", "spanCfgFailedTs", 37048, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("spanCfgFailedTs", prop)

    prop = PropMeta("str", "spanCfgState", "spanCfgState", 37047, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 37037, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 37036, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 37044, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
