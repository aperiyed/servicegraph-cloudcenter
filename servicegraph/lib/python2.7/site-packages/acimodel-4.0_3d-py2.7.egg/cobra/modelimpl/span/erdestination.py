...
# ##################################################
class ERDestination(Mo):
    """
    The ERSPAN destination, which is where network traffic is sent for analysis by a network analyzer.  When you create a traffic monitoring session, you must select an ERSPAN source and ERSPAN destination. The type of session (Tenant, Access, or Fabric) determines the allowed types of ERSPAN sources and destinations. The destination can be either a remote port or endpoint group. If the destination is a port, it should not be one that has been configured for other purposes.

    """

    meta = ClassMeta("cobra.model.span.ERDestination")

    meta.moClassName = "spanERDestination"
    meta.rnFormat = "erdst"
    meta.category = MoCategory.REGULAR
    meta.label = "ERSPAN Destination"
    ...
    prop = PropMeta("str", "dscp", "dscp", 2050, PropCategory.REGULAR)
    prop.label = "Dscp"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "dstIp", "dstIp", 2044, PropCategory.REGULAR)
    prop.label = "Destination IP"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("dstIp", prop)

    prop = PropMeta("str", "flowId", "flowId", 2046, PropCategory.REGULAR)
    prop.label = "Flow ID"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 1023)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14402, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operVer", "operVer", 24394, PropCategory.REGULAR)
    prop.label = "Version"
    prop.isOper = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "spanCfgFailedBmp", "spanCfgFailedBmp", 14939, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("span:ERDestinationdescr_failed_flag", None, 4)
    prop._addConstant("span:ERDestinationdscp_failed_flag", None, 64)
    prop._addConstant("span:ERDestinationdstIp_failed_flag", None, 128)
    prop._addConstant("span:ERDestinationflowId_failed_flag", None, 256)
    prop._addConstant("span:ERDestinationlcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("span:ERDestinationmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("span:ERDestinationmonPolDn_failed_flag", None, 512)
    prop._addConstant("span:ERDestinationmtu_failed_flag", None, 8)
    prop._addConstant("span:ERDestinationnameAlias_failed_flag", None, 2)
    prop._addConstant("span:ERDestinationname_failed_flag", None, 1)
    prop._addConstant("span:ERDestinationsrcIp_failed_flag", None, 16384)
    prop._addConstant("span:ERDestinationttl_failed_flag", None, 32768)
    prop._addConstant("span:ERDestinationtype_failed_flag", None, 65536)
    prop._addConstant("span:ERDestinationverEnforced_failed_flag", None, 262144)
    prop._addConstant("span:ERDestinationver_failed_flag", None, 131072)
    prop._addConstant("span:ERDestinationvnid_failed_flag", None, 524288)
    prop._addConstant("span:ERDestinationvrfName_failed_flag", None, 1048576)
    meta.props.add("spanCfgFailedBmp", prop)

    prop = PropMeta("str", "spanCfgFailedTs", "spanCfgFailedTs", 14941, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("spanCfgFailedTs", prop)

    prop = PropMeta("str", "spanCfgState", "spanCfgState", 14940, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("spanCfgState", prop)

    prop = PropMeta("str", "srcIp", "srcIp", 2043, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ttl", "ttl", 2047, PropCategory.REGULAR)
    prop.label = "TTL"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 255)]
    ...
    prop = PropMeta("str", "type", "type", 2042, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "gre"
    prop._addConstant("gre", "gre-encapsulated", 1)
    meta.props.add("type", prop)

    prop = PropMeta("str", "ver", "ver", 2045, PropCategory.REGULAR)
    prop.label = "Version"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "verEnforced", "verEnforced", 24091, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "vnid", "vnid", 2049, PropCategory.REGULAR)
    prop.label = "VNID"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("vnid", prop)

    prop = PropMeta("str", "vrfName", "vrfName", 2048, PropCategory.REGULAR)
    prop.label = "VRF"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
