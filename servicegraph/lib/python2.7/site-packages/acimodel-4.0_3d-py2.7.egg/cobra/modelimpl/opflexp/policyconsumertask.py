...
# ##################################################
class PolicyConsumerTask(Mo):
    """
    

    """

    meta = ClassMeta("cobra.model.opflexp.PolicyConsumerTask")

    meta.moClassName = "opflexpPolicyConsumerTask"
    meta.rnFormat = "opflexpPolicyConsumerTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('opflexpPolicyConsumerTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 22147, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("PolicyDemand", "policydemand", 1924)
