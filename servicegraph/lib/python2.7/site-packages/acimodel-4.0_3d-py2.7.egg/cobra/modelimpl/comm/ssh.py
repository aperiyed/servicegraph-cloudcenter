...
class Ssh(Mo):
    ...
    prop = PropMeta("str", "annotation", "annotation", 37534, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39673, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "sshCiphers", "sshCiphers", 36807, PropCategory.REGULAR)
