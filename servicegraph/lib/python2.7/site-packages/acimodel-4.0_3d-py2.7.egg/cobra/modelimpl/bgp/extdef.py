...
class ExtDef(Mo):
    """
    An internal object for the BGP external profile definition.

    """

    meta = ClassMeta("cobra.model.bgp.ExtDef")

    meta.moClassName = "bgpExtDef"
    ...
    prop = PropMeta("str", "enabledAf", "enabledAf", 17567, PropCategory.REGULAR)
    prop.label = "Enabled BGP Address Families"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop._addConstant("ipv4-ucast", "ipv4-unicast-address-family", 1)
    prop._addConstant("ipv6-ucast", "ipv6-unicast-address-family", 4)
    prop._addConstant("l2vpn-evpn", "l2vpn-evpn-address-family", 5)
    prop._addConstant("vpnv4-ucast", "vpnv4-unicast-address-family", 2)
    prop._addConstant("vpnv6-ucast", "vpnv6-unicast-address-family", 8)
