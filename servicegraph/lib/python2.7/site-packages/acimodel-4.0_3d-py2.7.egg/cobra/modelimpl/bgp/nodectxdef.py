...
class NodeCtxDef(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.NodeCtxDef")

    meta.moClassName = "bgpNodeCtxDef"
    meta.rnFormat = "bgpNodeCtxP"
    ...
    meta.parentClasses.add("cobra.model.bgp.ProtDef")
    ...
    prop = PropMeta("str", "bgpCtxPolDn", "bgpCtxPolDn", 30071, PropCategory.REGULAR)
    prop.label = "None"
