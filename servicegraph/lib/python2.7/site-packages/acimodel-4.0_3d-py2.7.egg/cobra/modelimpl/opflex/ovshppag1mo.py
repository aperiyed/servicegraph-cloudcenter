...
# ##################################################
class OvsHppAg1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsHppAg1mo", "ovs host protection stats")
    ...
    meta.moClassName = "opflexOvsHppAg1mo"
    meta.rnFormat = "CDopflexOvsHppAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ovs host protection stats stats in 1 month"
