...
# ##################################################
class AbsTermConn(Mo):
    """
    An abstract terminal node connector.

    """

    meta = ClassMeta("cobra.model.vns.AbsTermConn")

    meta.moClassName = "vnsAbsTermConn"
    meta.rnFormat = "AbsTConn"
    meta.category = MoCategory.REGULAR
    meta.label = "Terminal Connector"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37977, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40116, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14828, PropCategory.REGULAR)
