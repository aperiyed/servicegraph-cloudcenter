...
class SvcPol(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.SvcPol")

    meta.moClassName = "vnsSvcPol"
    meta.rnFormat = "svcpol_C-%(ctrct)s-G-%(graph)s-F-%(node)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L4-L7 policy container"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38765, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctrct", "ctrct", 34435, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40904, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "graph", "graph", 34436, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34440, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "node", "node", 34437, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    def __init__(self, parentMoOrDn, ctrct, graph, node, markDirty=True, **creationProps):
        namingVals = [ctrct, graph, node]
