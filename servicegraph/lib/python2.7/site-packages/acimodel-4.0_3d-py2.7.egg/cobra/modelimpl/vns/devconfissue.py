...
# ##################################################
class DevConfIssue(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.DevConfIssue")

    meta.moClassName = "vnsDevConfIssue"
    meta.rnFormat = "devConfIssue-%(issue)s"
    ...
    prop = PropMeta("str", "issue", "issue", 22695, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("lifctx-should-have-same-prefgrmemb", "invalid--all-the-lifctx-in-the-same-lif-should-have-prefgrmembe-value-set", 139)
    prop._addConstant("lifctx-should-have-same-qospol", "all-the-lifctx-using-same-device-and-same-bd-should-have-same-qospolicy-set.-retrigger-the-graph-after-fixing-misconfig", 148)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22722, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "priKey", "priKey", 22694, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
