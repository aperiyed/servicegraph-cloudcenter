...
class AbsConnection(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.AbsConnection")

    meta.moClassName = "vnsAbsConnection"
    meta.rnFormat = "AbsConnection-%(name)s"
    ...
    meta.childClasses.add("cobra.model.vns.RsAbsCopyConnection")
    ...
    meta.childClasses.add("cobra.model.vns.RsAbsConnectionConns")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Inst")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsAbsConnectionConns", "rsabsConnectionConns-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsAbsCopyConnection", "rsabsCopyConnection-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37978, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "directConnect", "directConnect", 27113, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40117, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14829, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7302, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
