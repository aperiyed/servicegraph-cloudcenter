...
class FltInst(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.FltInst")

    meta.moClassName = "vnsFltInst"
    meta.rnFormat = "fltInst-[%(aFltDn)s]"
    ...
    prop = PropMeta("str", "aFltDn", "aFltDn", 5126, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("aFltDn", prop)

    prop = PropMeta("str", "action", "action", 27811, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "markDscp", "markDscp", 41049, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "prio", "prio", 41047, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 9)]
    ...
    prop = PropMeta("str", "priorityOverride", "priorityOverride", 41046, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8
    ...
    prop = PropMeta("str", "remoteMarkDscp", "remoteMarkDscp", 41050, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "remotePrio", "remotePrio", 41048, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 9)]
    ...
    meta.namingProps.append(getattr(meta.props, "aFltDn"))
    getattr(meta.props, "aFltDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, aFltDn, markDirty=True, **creationProps):
        namingVals = [aFltDn]
