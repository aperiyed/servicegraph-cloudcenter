...
class NodeInst(Mo):
    """
    An instance of a function node. A service graph consists of multiple function nodes..

    """

    meta = ClassMeta("cobra.model.vns.NodeInst")

    meta.moClassName = "vnsNodeInst"
    meta.rnFormat = "NodeInst-%(name)s"
    ...
    meta.childClasses.add("cobra.model.vns.AbsFuncProfNormalized")
    meta.childClasses.add("cobra.model.vns.LegVNode")
    meta.childClasses.add("cobra.model.vns.FuncCfgInst")
    meta.childClasses.add("cobra.model.vns.RsNodeInstMeta")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.vns.FuncConnInst")
    meta.childClasses.add("cobra.model.vns.RsNodeInstToLDevCtx")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.AbsFuncProfNormalized", "absFuncProfNormalized-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsDefaultScopeToTerm", "rsdefaultScopeToTerm"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsNodeInstToLDevCtx", "rsNodeInstToLDevCtx"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsNodeInstMeta", "rsNodeInstMeta"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.FuncConnInst", "FConnInst-"))
    ...
    prop = PropMeta("str", "ctxName", "ctxName", 5116, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "encap", "encap", 15743, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ldevInst", "ldevInst", 20437, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ldevInst", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14856, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 7362, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "routingMode", "routingMode", 20988, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
