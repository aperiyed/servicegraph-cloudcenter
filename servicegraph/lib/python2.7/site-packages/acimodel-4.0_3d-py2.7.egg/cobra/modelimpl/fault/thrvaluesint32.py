...
# ##################################################
class ThrValueSint32(Mo):
    """
    The threshold value Service Interface Notification Statistics (SINT) 32.

    """

    meta = ClassMeta("cobra.model.fault.ThrValueSint32")

    meta.moClassName = "faultThrValueSint32"
    meta.rnFormat = "thrValSint32-%(propId)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38034, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40173, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "propId", "propId", 6510, PropCategory.REGULAR)
    prop.label = "Property"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "thrValue", "thrValue", 5478, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "value", "value", 5477, PropCategory.REGULAR)
