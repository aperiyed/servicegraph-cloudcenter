...
# ##################################################
class RsTrExtEpIpDst(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.traceroutep.RsTrExtEpIpDst", "cobra.model.fv.Ip")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "traceroutepRsTrExtEpIpDst"
    meta.rnFormat = "rstrExtEpIpDst-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 43544, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "bdDn", "bdDn", 43501, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("bdDn", prop)

    prop = PropMeta("str", "bdSeg", "bdSeg", 43502, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "encap", "encap", 43503, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 43545, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ipAddr", "ipAddr", 43504, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ipAddr", prop)

    prop = PropMeta("str", "ipSubnet", "ipSubnet", 43505, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "mac", "mac", 43506, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43539, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 43508, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 43507, PropCategory.REGULAR)
