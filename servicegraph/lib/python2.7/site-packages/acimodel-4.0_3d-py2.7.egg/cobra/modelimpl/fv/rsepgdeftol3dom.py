...
# ##################################################
class RsEPgDefToL3Dom(Mo):
    """
    The Layer 3 Domain (VRF).

    """

    meta = SourceRelationMeta("cobra.model.fv.RsEPgDefToL3Dom", "cobra.model.l3.Dom")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsEPgDefToL3Dom"
    meta.rnFormat = "rsEPgDefToL3Dom"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "EPgDef to L3 Domain Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 15276, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 15275, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 15306, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
