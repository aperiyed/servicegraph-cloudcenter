...
class PolMod(Mo):
    """
    A bridge domain policy modifier that can override the desired state of the bridge domain.

    """

    meta = ClassMeta("cobra.model.fv.PolMod")

    meta.moClassName = "fvPolMod"
    meta.rnFormat = "polMod"
    ...
    meta.childClasses.add("cobra.model.fv.RtPolModAtt")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtPolModAtt", "rtvnsPolModAtt-"))
    ...
    prop = PropMeta("str", "arpFlood", "arpFlood", 1700, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "unicastRoute", "unicastRoute", 1699, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "unkMcastAct", "unkMcastAct", 16165, PropCategory.REGULAR)
