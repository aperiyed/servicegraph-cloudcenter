...
class RtEctx(Mo):
    """
    A target relation to a private layer 3 network context that belongs to a specific tenant or is shared. This is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtEctx", "cobra.model.l3ext.Out")

    meta.moClassName = "fvRtEctx"
    meta.rnFormat = "rtl3extEctx-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "L3 Outside"
    meta.writeAccessMask = 0x2001
    meta.readAccessMask = 0x6010010021002701
    ...
    prop = PropMeta("str", "tCl", "tCl", 12095, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12094, PropCategory.REGULAR)
