...
class CCg(Mo):
    """
    A special endpoint group representing a set of connectivity rules to a compute container or hypervisor.

    """

    meta = ClassMeta("cobra.model.fv.CCg")

    meta.moClassName = "fvCCg"
    meta.rnFormat = "ccg-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Compute Container Group"
    ...
    prop = PropMeta("str", "encap", "encap", 1727, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6532, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
