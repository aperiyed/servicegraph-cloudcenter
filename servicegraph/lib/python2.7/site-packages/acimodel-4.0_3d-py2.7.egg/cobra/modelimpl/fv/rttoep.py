...
class RtToEp(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtToEp", "cobra.model.dbgac.ToEpCmn")

    meta.moClassName = "fvRtToEp"
    meta.rnFormat = "rtdbgacToEp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 24132, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 12934, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12933, PropCategory.REGULAR)
