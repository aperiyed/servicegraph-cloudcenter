...
class EpAnycast(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.EpAnycast")

    meta.moClassName = "fvEpAnycast"
    meta.rnFormat = "epAnycast-%(mac)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38817, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40956, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "mac", "mac", 37066, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 36851, PropCategory.REGULAR)
