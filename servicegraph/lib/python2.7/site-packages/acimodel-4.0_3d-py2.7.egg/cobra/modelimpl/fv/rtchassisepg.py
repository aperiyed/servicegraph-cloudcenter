...
# ##################################################
class RtChassisEpg(Mo):
    """
    A target relation to a set of endpoints.

    """

    meta = TargetRelationMeta("cobra.model.fv.RtChassisEpg", "cobra.model.vns.Chassis")

    meta.moClassName = "fvRtChassisEpg"
    meta.rnFormat = "rtvnsChassisEpg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 18377, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 18376, PropCategory.REGULAR)
