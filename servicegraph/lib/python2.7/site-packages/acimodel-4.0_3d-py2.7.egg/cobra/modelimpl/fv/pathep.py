...
class PathEp(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.PathEp")

    meta.moClassName = "fvPathEp"
    meta.rnFormat = "pathep-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Path End Point (Interface)"
    ...
    prop = PropMeta("str", "name", "name", 6552, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
