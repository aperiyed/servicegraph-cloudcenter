...
class TnlEPg(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.TnlEPg")

    meta.moClassName = "fvTnlEPg"
    meta.rnFormat = "Tnlepg-%(name)s"
    ...
    meta.childClasses.add("cobra.model.fv.RsTnlCtx")
    ...
    meta.childClasses.add("cobra.model.fv.RsTnlpathAtt")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsTnlpathAtt", "rstnlpathAtt-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsTnlCtx", "rstnlCtx"))
    ...
    prop = PropMeta("str", "accEncap", "accEncap", 30406, PropCategory.REGULAR)
    prop.label = "Access Encapsulation"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("accEncap", prop)

    prop = PropMeta("str", "annotation", "annotation", 38542, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "bcastP", "bcastP", 28316, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("bcastP", prop)

    prop = PropMeta("str", "bdSegid", "bdSegid", 27841, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ctxPcTag", "ctxPcTag", 27843, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctxSegid", "ctxSegid", 27842, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40681, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "fwdCtrl", "fwdCtrl", 30407, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27315, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 27281, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "qiqL2ProtTunMask", "qiqL2ProtTunMask", 27276, PropCategory.REGULAR)
