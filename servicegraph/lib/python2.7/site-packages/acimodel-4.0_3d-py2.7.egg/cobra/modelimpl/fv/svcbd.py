...
class SvcBD(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.SvcBD")

    meta.moClassName = "fvSvcBD"
    meta.rnFormat = "svcBD-%(name)s"
    ...
    meta.childClasses.add("cobra.model.fv.RsSvcBDToBDAtt")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsSvcBDToBDAtt", "rsSvcBDToBDAtt"))
    ...
    prop = PropMeta("str", "isCopySvc", "isCopySvc", 26364, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14252, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 6560, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
