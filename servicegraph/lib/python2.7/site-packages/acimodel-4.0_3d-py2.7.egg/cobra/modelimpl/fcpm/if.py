...
# ##################################################
class If(Mo):
    meta = ClassMeta("cobra.model.fcpm.If")

    meta.isAbstract = True
    meta.moClassName = "fcpmIf"
    ...
    meta.concreteSubClasses.add("cobra.model.fcpm.FcPhysIf")
    meta.concreteSubClasses.add("cobra.model.fcpm.FcAggrIf")
