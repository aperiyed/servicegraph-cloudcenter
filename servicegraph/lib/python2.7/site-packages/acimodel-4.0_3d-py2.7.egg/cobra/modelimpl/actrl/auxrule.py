...
class AuxRule(Mo):
    ...
    meta = ClassMeta("cobra.model.actrl.AuxRule")

    meta.moClassName = "actrlAuxRule"
    meta.rnFormat = "rule-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Access Control Auxillary Rule"
    ...
    meta.childClasses.add("cobra.model.actrl.RtAuxRule")

    meta.childNamesAndRnPrefix.append(("cobra.model.actrl.RtAuxRule", "rtAuxRule"))
    ...
    prop = PropMeta("str", "ctrName", "ctrName", 42399, PropCategory.REGULAR)
    prop.label = "Contract name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("ctrName", prop)

    prop = PropMeta("str", "direction", "direction", 2126, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "flags", "flags", 45465, PropCategory.REGULAR)
    prop.label = "Flags"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("nostats", "stats-is-disabled", 1)
    meta.props.add("flags", prop)

    prop = PropMeta("str", "fltid", "fltid", 2122, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "id", "id", 2121, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "prio", "prio", 2123, PropCategory.REGULAR)
    prop.label = "Priority"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 23)]
    ...
    prop = PropMeta("str", "ruleNodeId", "ruleNodeId", 2124, PropCategory.REGULAR)
    prop.label = "Rule Node ID"
    prop.isOper = True
    prop.range = [(1, 4294967295)]
    meta.props.add("ruleNodeId", prop)

    prop = PropMeta("str", "scopeId", "scopeId", 2125, PropCategory.REGULAR)
    prop.label = "Scope ID"
    prop.isImplicit = True
    prop.isAdmin = True
