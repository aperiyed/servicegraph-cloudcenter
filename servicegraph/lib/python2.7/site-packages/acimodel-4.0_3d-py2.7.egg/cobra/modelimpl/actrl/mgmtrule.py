...
class MgmtRule(Mo):
    ...
    prop._addConstant("actrl:MgmtRulemarkDscp_failed_flag", None, 512)
    prop._addConstant("actrl:MgmtRulemodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("actrl:MgmtRulemonPolDn_failed_flag", None, 1048576)
    prop._addConstant("actrl:MgmtRulenameAlias_failed_flag", None, 2)
    prop._addConstant("actrl:MgmtRulename_failed_flag", None, 1)
    prop._addConstant("actrl:MgmtRuleprio_failed_flag", None, 4096)
    prop._addConstant("actrl:MgmtRuleqosGrp_failed_flag", None, 8192)
    prop._addConstant("actrl:MgmtRulesPcTag_failed_flag", None, 16384)
    prop._addConstant("actrl:MgmtRulescopeId_failed_flag", None, 32768)
    prop._addConstant("actrl:MgmtRuletype_failed_flag", None, 65536)
