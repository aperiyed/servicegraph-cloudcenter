...
# ##################################################
class RuleHitAgHist1mo(Mo):
    """
    A class that represents historical aggregated statistics for rule hits in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.actrl.RuleHitAgHist1mo", "rule hits")
    ...
    meta.moClassName = "actrlRuleHitAgHist1mo"
    meta.rnFormat = "HDactrlRuleHitAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated rule hits stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 5818, PropCategory.REGULAR)
