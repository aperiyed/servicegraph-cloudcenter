...
# ##################################################
class ARule(Mo):
    meta = ClassMeta("cobra.model.actrl.ARule")

    meta.isAbstract = True
    meta.moClassName = "actrlARule"
    ...
    prop = PropMeta("str", "dPcTag", "dPcTag", 2152, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "fltId", "fltId", 2153, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "sPcTag", "sPcTag", 2151, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "scopeId", "scopeId", 2150, PropCategory.REGULAR)
    prop.label = "Scope ID"
    prop.isImplicit = True
    prop.isAdmin = True
