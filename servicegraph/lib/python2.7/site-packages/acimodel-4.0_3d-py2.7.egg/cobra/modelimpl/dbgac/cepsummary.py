...
class CEpSummary(Mo):
    ...
    meta = ClassMeta("cobra.model.dbgac.CEpSummary")

    meta.moClassName = "dbgacCEpSummary"
    meta.rnFormat = "acCEpSummary-[%(epDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "endpoints bd, ctx and epDn"
    ...
    meta.childClasses.add("cobra.model.dbgac.AcEpNode")

    meta.childNamesAndRnPrefix.append(("cobra.model.dbgac.AcEpNode", "acEpNode-"))
    ...
    prop = PropMeta("str", "bdDn", "bdDn", 24122, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("bdDn", prop)

    prop = PropMeta("str", "bdEncap", "bdEncap", 24117, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctxEncap", "ctxEncap", 24118, PropCategory.REGULAR)
    prop.label = "AC Packet Context Encap"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ctxEncap", prop)

    prop = PropMeta("str", "ctxName", "ctxName", 24120, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "epDn", "epDn", 24121, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "epgDn", "epgDn", 25942, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("epgDn", prop)

    prop = PropMeta("str", "ipAddr", "ipAddr", 24123, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "mac", "mac", 24124, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "pcTag", "pcTag", 25943, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 24119, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
