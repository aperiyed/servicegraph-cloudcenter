...
class MacEpFault(Mo):
    ...
    meta = ClassMeta("cobra.model.epm.MacEpFault")

    meta.moClassName = "epmMacEpFault"
    meta.rnFormat = "macEPFault-%(addr)s"
    ...
    prop = PropMeta("str", "addr", "addr", 35731, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop._addConstant("rogue-max-ips", "maximum-number-of-ips-per-mac-exceeds-threshold", 35184372088832)
