...
# ##################################################
class IngrBytesAg1mo(Mo):
    """
    A class that represents the most current aggregated statistics for ingress bytes in a 1 month sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrBytesAg1mo", "ingress bytes")
    ...
    meta.moClassName = "l2IngrBytesAg1mo"
    meta.rnFormat = "CDl2IngrBytesAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ingress bytes stats in 1 month"
