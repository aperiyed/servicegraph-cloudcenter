...
class FcBrIf(Mo):
    ...
    meta = ClassMeta("cobra.model.l2.FcBrIf")

    meta.moClassName = "l2FcBrIf"
    ...
    meta.childClasses.add("cobra.model.l2.RsFcBrConf")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l2.RsFcBrConf", "rsfcBrConf"))
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 38874, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "id", "id", 39110, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mode", "mode", 38876, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42511, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "trkingMode", "trkingMode", 38875, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "txBufferCredits", "txBufferCredits", 42767, PropCategory.REGULAR)
    prop.label = "TX Buffer Credits"
    prop.isOper = True
    meta.props.add("txBufferCredits", prop)
