...
# ##################################################
class IngrPktsPartHist1qtr(Mo):
    """
    A class that represents historical portion of the statistics for ingress packets in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.l2.IngrPktsPartHist1qtr", "ingress packets")
    ...
    meta.moClassName = "l2IngrPktsPartHist1qtr"
    meta.rnFormat = "HDl2IngrPktsPart1qtr-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the ingress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 6822, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 6823, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
