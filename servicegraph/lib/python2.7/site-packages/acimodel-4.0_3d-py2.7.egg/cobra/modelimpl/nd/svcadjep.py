...
class SvcAdjEp(Mo):
    ...
    meta = ClassMeta("cobra.model.nd.SvcAdjEp")

    meta.moClassName = "ndSvcAdjEp"
    meta.rnFormat = "svcadj-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "ND Service Adjacency"
    ...
    meta.parentClasses.add("cobra.model.nd.CktEp")
    ...
    prop = PropMeta("str", "addr", "addr", 27172, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operSt", "operSt", 27160, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 27161, PropCategory.REGULAR)
