...
class If(Mo):
    """
    CDP information that is operated at a interface level. CDP is used to obtain protocol addresses of neighboring devices and discover the platform of those devices. CDP is also used to display information about the neighboring interfaces/devices.

    """

    meta = ClassMeta("cobra.model.cdp.If")

    meta.moClassName = "cdpIf"
    meta.rnFormat = "if-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "CDP Interface"
    ...
    meta.childClasses.add("cobra.model.cdp.IfStats")
    meta.childClasses.add("cobra.model.l2.RsEthIf")
    meta.childClasses.add("cobra.model.cdp.AdjEp")
    meta.childClasses.add("cobra.model.nw.RtPathToIf")

    meta.childNamesAndRnPrefix.append(("cobra.model.nw.RtPathToIf", "rtpathToIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cdp.IfStats", "ifstats"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l2.RsEthIf", "rsethIf"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cdp.AdjEp", "adj-"))

    meta.parentClasses.add("cobra.model.cdp.Inst")
    ...
    prop = PropMeta("str", "id", "id", 5897, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "locDesc", "locDesc", 15677, PropCategory.REGULAR)
    prop.label = "Location Description"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 128)]
    prop.regex = ['[a-zA-Z0-9\\!#$%()*,-./:;@ _{|}~?&+]+']
    meta.props.add("locDesc", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14455, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nativeVlan", "nativeVlan", 2729, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operSt", "operSt", 2727, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 2728, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "portDesc", "portDesc", 15329, PropCategory.REGULAR)
