...
# ##################################################
class ExtRoutableMcastIpTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fabric.ExtRoutableMcastIpTask")

    meta.moClassName = "fabricExtRoutableMcastIpTask"
    meta.rnFormat = "fabricExtRoutableMcastIpTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('fabricExtRoutableMcastIpTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 45413, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateExtConnPDef", "updateextconnpdef", 3267)
