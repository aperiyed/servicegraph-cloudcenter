...
# ##################################################
class RsUsedUcastIp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsUsedUcastIp", "cobra.model.fabric.ExtRoutableUcastIp")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fabricRsUsedUcastIp"
    meta.rnFormat = "rsusedUcastIp-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "UCast TEP"
    ...
    prop = PropMeta("str", "tCl", "tCl", 49933, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 13111
    prop.defaultValueStr = "fabricExtRoutableUcastIp"
    prop._addConstant("fabricExtRoutableUcastIp", None, 13111)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 49932, PropCategory.REGULAR)
