...
# ##################################################
class ExtRoutableUcastIpTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fabric.ExtRoutableUcastIpTask")

    meta.moClassName = "fabricExtRoutableUcastIpTask"
    meta.rnFormat = "fabricExtRoutableUcastIpTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('fabricExtRoutableUcastIpTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 45416, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdatePodConnPDef", "updatepodconnpdef", 3266)
