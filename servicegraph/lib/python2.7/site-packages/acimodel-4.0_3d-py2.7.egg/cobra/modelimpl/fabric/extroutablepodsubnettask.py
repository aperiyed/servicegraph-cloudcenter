...
# ##################################################
class ExtRoutablePodSubnetTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fabric.ExtRoutablePodSubnetTask")

    meta.moClassName = "fabricExtRoutablePodSubnetTask"
    meta.rnFormat = "fabricExtRoutablePodSubnetTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('fabricExtRoutablePodSubnetTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 45415, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("Remove", "remove", 3263)
    prop._addConstant("UpdatePodConnPDef", "updatepodconnpdef", 3269)
