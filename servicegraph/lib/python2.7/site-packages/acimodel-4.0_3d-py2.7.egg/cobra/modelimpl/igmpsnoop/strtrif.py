...
class StRtrIf(Mo):
    """
    This object represents the multicast router if that is configured statically.

    """

    meta = ClassMeta("cobra.model.igmpsnoop.StRtrIf")

    meta.moClassName = "igmpsnoopStRtrIf"
    meta.rnFormat = "strtrif-[%(id)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "IGMP Static Router Interface"
    ...
    prop = PropMeta("str", "id", "id", 6606, PropCategory.REGULAR)
