...
class RsSvrEpg(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.dnsepg.RsSvrEpg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "dnsepgRsSvrEpg"
    meta.rnFormat = "rssvrEpg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from a dnsepgSvrGrp to an EPG"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38697, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "bdmac", "bdmac", 33298, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "bdseg", "bdseg", 33299, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40836, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33305, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "seg", "seg", 33300, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 33302, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 33301, PropCategory.REGULAR)
