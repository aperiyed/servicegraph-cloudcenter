...
class EncRtdIf(Mo):
    ...
    meta = ClassMeta("cobra.model.ethpm.EncRtdIf")

    meta.moClassName = "ethpmEncRtdIf"
    meta.rnFormat = "encrtdif"
    ...
    prop = PropMeta("str", "currErrIndex", "currErrIndex", 3849, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "fsmState", "fsmState", 3844, PropCategory.REGULAR)
    prop.label = "Fsm Stat"
    prop.isOper = True
    meta.props.add("fsmState", prop)

    prop = PropMeta("str", "hwBdId", "hwBdId", 3853, PropCategory.REGULAR)
    prop.label = "Hw Bd Id (allocated for L3 Sub-ifs)"
    prop.isOper = True
    prop.range = [(1, 4096)]
    meta.props.add("hwBdId", prop)

    prop = PropMeta("str", "hwResourceId", "hwResourceId", 26238, PropCategory.REGULAR)
    prop.label = "Hardware Resource Identifier"
    prop.isOper = True
    prop.range = [(0, 32767)]
    meta.props.add("hwResourceId", prop)

    prop = PropMeta("str", "iod", "iod", 3845, PropCategory.REGULAR)
    prop.label = "Iod"
    prop.isOper = True
    meta.props.add("iod", prop)

    prop = PropMeta("str", "lastErrors", "lastErrors", 3850, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operBitset", "operBitset", 3851, PropCategory.REGULAR)
    prop.label = "Operational State Flags"
    prop.isOper = True
    meta.props.add("operBitset", prop)

    prop = PropMeta("str", "operMtu", "operMtu", 3848, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operSt", "operSt", 3846, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 3847, PropCategory.REGULAR)
    ...
    prop._addConstant("domain-addr-assign-failure-isolation", "isolated", 101)
    prop._addConstant("domain-invalid-rcf-received", "isolated", 102)
    prop._addConstant("domain-isolation-unknown-reason", "isolated", 103)
    prop._addConstant("domain-manager-disabled", "isolated", 104)
    prop._addConstant("domain-max-retransmission-failure", "isolated", 38)
    prop._addConstant("domain-not-allowed-isolation", "isolated", 105)
    prop._addConstant("domain-other-side-eport-isolated", "isolated", 106)
    prop._addConstant("domain-overlap-isolation", "isolated", 107)
    prop._addConstant("dot1x-security-errdisable", "dot1xsecurityerrdisable", 94)
    prop._addConstant("dpvm-vsan-not-found", "suspended", 108)
    prop._addConstant("dpvm-vsan-suspended", "suspended", 109)
    prop._addConstant("ec-suspended-for-loop", "suspended", 110)
    prop._addConstant("elp-failure-all-zero-peer-wwn-rcvd", "elpfailzpeer", 111)
    prop._addConstant("elp-failure-classf-param-err", "isolated", 112)
    prop._addConstant("elp-failure-classn-param-err", "isolated", 113)
    prop._addConstant("elp-failure-invalid-flow-ctl-param", "isolated", 114)
    prop._addConstant("elp-failure-invalid-payload-size", "isolated", 115)
    prop._addConstant("elp-failure-invalid-port-name", "isolated", 116)
    prop._addConstant("elp-failure-invalid-switch-name", "isolated", 117)
    prop._addConstant("elp-failure-invalid-tx-bbcredit", "isolated", 118)
    prop._addConstant("elp-failure-isolation", "isolated", 119)
    prop._addConstant("elp-failure-loopback-detected", "isolated", 120)
    prop._addConstant("elp-failure-ratov-edtov-mismatch", "isolated", 121)
    prop._addConstant("elp-failure-revision-mismatch", "isolated", 122)
    prop._addConstant("elp-failure-unknown-flow-ctl-code", "isolated", 123)
    prop._addConstant("epm-learn-err-disable", "epmlearn-errdisable", 76)
    prop._addConstant("eport-prohibited", "ficonprohibit", 124)
    prop._addConstant("epp-failure", "err-disabled", 125)
    prop._addConstant("err-disabled", "err-disabled", 9)
    prop._addConstant("err-disabled-ip-conflict", "conflcterrdis", 18)
    prop._addConstant("esc-failure-isolation", "isolated", 126)
    ...
    prop._addConstant("fabric-bind-failure", "isolated", 132)
    prop._addConstant("fabric-binding-database-mismatch", "isolated", 128)
    prop._addConstant("fabric-binding-domain-invalid", "isolated", 129)
    prop._addConstant("fabric-binding-peer-not-responding", "isolated", 130)
    prop._addConstant("fabric-binding-swwn-not-found", "isolated", 131)
    prop._addConstant("fabric-track", "fabrictrack", 78)
    prop._addConstant("fail", "fail", 4)
    prop._addConstant("fc-redirect-isolation", "isolated", 135)
    ...
    prop._addConstant("fcsp-authent-failure", "isolated", 134)
    ...
    prop._addConstant("ficon-not-enabled", "err-disabled", 137)
    ...
    prop._addConstant("incompatible-admin-rxbbcredit", "err-disabled", 141)
    prop._addConstant("incompatible-admin-rxbbcredit-performance-buf", "err-disabled", 142)
    prop._addConstant("incompatible-admin-rxbufsize", "err-disabled", 143)
    ...
    prop._addConstant("invalid-fabric-binding-exchange", "isolated", 147)
    ...
    prop._addConstant("link-fail-credit-loss", "notconnect", 149)
    prop._addConstant("link-fail-credit-loss-b2b", "notconnect", 150)
    prop._addConstant("link-fail-debounce-timeout", "notconnect", 151)
    prop._addConstant("link-fail-line-card-port-shutdown", "notconnect", 152)
    prop._addConstant("link-fail-lip-f8-rcvd", "notconnect", 153)
    prop._addConstant("link-fail-lip-rcvd-b2b", "notconnect", 154)
    prop._addConstant("link-fail-loss-of-signal", "notconnect", 155)
    prop._addConstant("link-fail-loss-of-sync", "notconnect", 156)
    prop._addConstant("link-fail-lr-rcvd-b2b", "notconnect", 157)
    prop._addConstant("link-fail-nos-rcvd", "notconnect", 158)
    prop._addConstant("link-fail-ols-rcvd", "notconnect", 159)
    prop._addConstant("link-fail-opny-ret-b2b", "notconnect", 160)
    prop._addConstant("link-fail-opny-tmo-b2b", "notconnect", 161)
    ...
    prop._addConstant("link-fail-rx-que-overflow", "notconnect", 163)
    ...
    prop._addConstant("no-trunk-oper-vsans-isolation", "isolated", 166)
    ...
    prop._addConstant("ohms-external-lb-test", "suspended", 167)
    prop._addConstant("osm-e-port-up", "errdisabled", 168)
    ...
    prop._addConstant("peer-fcip-closed-tcp-connection", "peerdown", 170)
    prop._addConstant("peer-fcip-reset-tcp-connection", "peerdown", 171)
    prop._addConstant("peer-not-support-bundles", "suspended", 172)
    prop._addConstant("poe-err-disabled", "poeerrdisable", 200)
    ...
    prop._addConstant("port-bind-failure", "isolated", 174)
    prop._addConstant("port-blocked", "portblcked", 175)
    prop._addConstant("port-bringup-isolation", "isolated", 176)
    ...
    prop._addConstant("port-vsan-mismatch-isolation", "isolated", 179)
    prop._addConstant("prefered-path-isolation", "isolated", 180)
    ...
    prop._addConstant("sdm-isolation", "isolated", 182)
    ...
    prop._addConstant("suspended-by-wwn", "suspended", 184)
    ...
    prop._addConstant("tcp-keep-alive-timer-expired", "tcpdown", 185)
    prop._addConstant("tcp-max-retransmissions", "tcpdown", 186)
    prop._addConstant("tcp-persist-timer-expired", "tcpdown", 187)
    prop._addConstant("too-many-invalid-flogis", "invldflgis", 188)
    prop._addConstant("tov-mismatch", "isolated", 189)
    ...
    prop._addConstant("virtual-ivr-domain-overlap-isolation", "isolated", 195)
    ...
    prop._addConstant("vsan-mismatch-isolation", "isolated", 196)
    ...
    prop._addConstant("zone-merge-failure-isolation", "isolated", 197)
    prop._addConstant("zone-remote-no-resp-isolation", "isolated", 198)
    ...
    prop = PropMeta("str", "siCfgFlags", "siCfgFlags", 3852, PropCategory.REGULAR)
    prop.label = "Sub-interface Configuration Flags"
    prop.isOper = True
    meta.props.add("siCfgFlags", prop)
