...
# ##################################################
class ARwi(Mo):
    meta = ClassMeta("cobra.model.adcom.ARwi")

    meta.isAbstract = True
    meta.moClassName = "adcomARwi"


    meta.moClassName = "adcomARwi"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstract Replica Wire Impression"
    ...
    prop = PropMeta("str", "rplId", "rplId", 1423, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "shrdId", "shrdId", 1422, PropCategory.REGULAR)
    prop.label = "Shard ID"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "svcId", "svcId", 1421, PropCategory.REGULAR)
