...
class NetIdent(Mo):
    ...
    meta = ClassMeta("cobra.model.adcom.NetIdent")

    meta.moClassName = "adcomNetIdent"
    meta.rnFormat = "ident--%(dirctn)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Network Identity"
    ...
    prop = PropMeta("str", "dirctn", "dirctn", 1404, PropCategory.REGULAR)
    ...
    prop._addConstant("dst", "destination", 2)
    prop._addConstant("not-defined", "direction-not-defined", 100)
    prop._addConstant("src", "source", 1)
    meta.props.add("dirctn", prop)
    ...
    prop = PropMeta("str", "slot", "slot", 1408, PropCategory.REGULAR)
    prop.label = "Slot Number"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "not-defined"
    prop._addConstant("dynamic", "slot-dynamic", 256)
    prop._addConstant("max-static", "slot-max-static", 15)
    prop._addConstant("min-dynamic", "slot-min-dynamic", 256)
    prop._addConstant("not-defined", "slot-not-defined", 0)
    meta.props.add("slot", prop)
    ...
    prop = PropMeta("str", "svcId", "svcId", 1407, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "sysId", "sysId", 1406, PropCategory.REGULAR)
    prop.label = "System Id"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("sysId", prop)

    prop = PropMeta("str", "sysTy", "sysTy", 1405, PropCategory.REGULAR)
    prop.label = "System Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "not-specified"
    prop._addConstant("controller", "systype-controller", 2)
    prop._addConstant("node", "systype-node", 1)
    prop._addConstant("not-specified", "systype-not-specified", 0)
    prop._addConstant("sync-peer", "systype-sync-peer", 3)
    meta.props.add("sysTy", prop)

    meta.namingProps.append(getattr(meta.props, "dirctn"))

    def __init__(self, parentMoOrDn, dirctn, markDirty=True, **creationProps):
        namingVals = [dirctn]
