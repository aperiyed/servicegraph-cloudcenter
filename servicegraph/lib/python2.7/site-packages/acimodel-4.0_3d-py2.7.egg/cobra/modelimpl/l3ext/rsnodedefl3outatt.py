...
class RsNodeDefL3OutAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.l3ext.RsNodeDefL3OutAtt", "cobra.model.fabric.Node")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3extRsNodeDefL3OutAtt"
    meta.rnFormat = "rsnodeDefL3OutAtt-[%(tDn)s]"
    ...
    meta.childClasses.add("cobra.model.l3ext.LoopBackIfPDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.LoopBackIfPDef", "lbpdef-"))
    ...
    prop = PropMeta("str", "fabricExtCtrlPeering", "fabricExtCtrlPeering", 21438, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "fabricExtIntersiteCtrlPeering", "fabricExtIntersiteCtrlPeering", 29963, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop = PropMeta("str", "ipv4LbAddr", "ipv4LbAddr", 17845, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ipv4LbAddr", prop)

    prop = PropMeta("str", "ipv6LbAddr", "ipv6LbAddr", 17846, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "rtrId", "rtrId", 12111, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("rtrId", prop)

    prop = PropMeta("str", "rtrIdLoopBack", "rtrIdLoopBack", 19766, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 12110, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12109, PropCategory.REGULAR)
