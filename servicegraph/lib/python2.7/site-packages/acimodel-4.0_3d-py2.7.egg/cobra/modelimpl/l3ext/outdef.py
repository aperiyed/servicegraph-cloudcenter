...
class OutDef(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.OutDef")

    meta.moClassName = "l3extOutDef"
    meta.rnFormat = "outdef-%(name)s"
    ...
    meta.childClasses.add("cobra.model.l3ext.RsBgpAsP")
    ...
    meta.childClasses.add("cobra.model.l3ext.RtLIfCtxToOutDef")
    meta.childClasses.add("cobra.model.l3ext.InstPDef")
    meta.childClasses.add("cobra.model.tag.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtLIfCtxToOutDef", "rtvnsLIfCtxToOutDef-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.InstPDef", "instPdef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.ExtDef", "ospfExtP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsBgpAsP", "rsbgpAsP"))
    ...
    prop = PropMeta("str", "ctxDn", "ctxDn", 18209, PropCategory.REGULAR)
    prop.label = "l3 context dn for this OutDef"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ctxDn", prop)

    prop = PropMeta("str", "ctxName", "ctxName", 17821, PropCategory.REGULAR)
    prop.label = "l3 context name for this OutDef"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("ctxName", prop)

    prop = PropMeta("str", "ctxPcTag", "ctxPcTag", 19790, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ctxScope", "ctxScope", 19789, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("ctxScope", prop)

    prop = PropMeta("str", "ctxSeg", "ctxSeg", 19791, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 17851, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 17844, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "routeTag", "routeTag", 19792, PropCategory.REGULAR)
