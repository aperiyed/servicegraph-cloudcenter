...
class Out(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.Out")

    meta.moClassName = "l3extOut"
    ...
    meta.childClasses.add("cobra.model.eigrp.ExtP")
    meta.childClasses.add("cobra.model.bgp.RtTargetInstrP")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.rtctrl.Profile")
    meta.childClasses.add("cobra.model.l2.IngrBytesAg15min")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.l3ext.LNodeP")
    meta.childClasses.add("cobra.model.l3ext.RtOutDefContToOut")
    meta.childClasses.add("cobra.model.l3ext.RtBDToOut")
    meta.childClasses.add("cobra.model.l2.IngrBytesAgHist1mo")
    meta.childClasses.add("cobra.model.l2.IngrPktsAgHist1mo")
    meta.childClasses.add("cobra.model.l3ext.RtSrcToL3extOut")
    meta.childClasses.add("cobra.model.l2.IngrPktsAgHist1qtr")
    meta.childClasses.add("cobra.model.l3ext.ConsLbl")
    meta.childClasses.add("cobra.model.tag.Inst")
    meta.childClasses.add("cobra.model.l3ext.RsDampeningPol")
    ...
    meta.childClasses.add("cobra.model.l3ext.InstP")
    ...
    meta.childClasses.add("cobra.model.l3ext.CtxUpdater")
    meta.childClasses.add("cobra.model.tag.Tag")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.l3ext.RtLIfCtxToOut")
    meta.childClasses.add("cobra.model.pim.ExtP")
    meta.childClasses.add("cobra.model.l3ext.RtTrExtExtl3extOutSrc")
    meta.childClasses.add("cobra.model.l2.IngrBytesAg1year")
    meta.childClasses.add("cobra.model.l2.IngrPktsAg1year")
    meta.childClasses.add("cobra.model.ospf.ExtP")
    meta.childClasses.add("cobra.model.l2.IngrPktsAgHist15min")
    meta.childClasses.add("cobra.model.l3ext.RsEctx")
    meta.childClasses.add("cobra.model.tag.ExtMngdInst")
    meta.childClasses.add("cobra.model.l3ext.ExtEncapAllocator")
    meta.childClasses.add("cobra.model.l3ext.ProvLbl")
    meta.childClasses.add("cobra.model.tag.AliasInst")
    meta.childClasses.add("cobra.model.l2.IngrBytesAg1mo")
    meta.childClasses.add("cobra.model.l3ext.DefaultRouteLeakP")
    meta.childClasses.add("cobra.model.l2.IngrPktsAgHist1d")
    meta.childClasses.add("cobra.model.l3ext.RtTrExtEpl3extOutSrc")
    meta.childClasses.add("cobra.model.l3ext.RtBDSubnetToOut")
    meta.childClasses.add("cobra.model.bgp.ExtP")
    ...
    meta.childClasses.add("cobra.model.l3ext.RsOutToBDPublicSubnetHolder")
    meta.childClasses.add("cobra.model.l3ext.RsInterleakPol")
    meta.childClasses.add("cobra.model.l2.IngrPktsAg15min")
    meta.childClasses.add("cobra.model.l3ext.RsL3DomAtt")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsOutToBDPublicSubnetHolder", "rsoutToBDPublicSubnetHolder-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l2.IngrBytesAgHist1year", "HDl2IngrBytesAg1year-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtTrExtExtl3extOutSrc", "rttrExtExtl3extOutSrc"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtSrcToL3extOut", "rtspanSrcToL3extOut-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtTrExtEpl3extOutSrc", "rttrExtEpl3extOutSrc"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtOutDefContToOut", "rtoutDefContToOut-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtBDSubnetToOut", "rtfvBDSubnetToOut-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtLIfCtxToOut", "rtvnsLIfCtxToOut-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsDampeningPol", "rsdampeningPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.RtTargetInstrP", "rttargetinstrp"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsInterleakPol", "rsinterleakPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtBDToOut", "rtfvBDToOut-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsL3DomAtt", "rsl3DomAtt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.eigrp.ExtP", "eigrpExtP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.AliasDelInst", "aliasdel-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.DefaultRouteLeakP", "defrtleak"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.ConsLbl", "conslbl-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.ExtP", "ospfExtP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.ProvLbl", "provlbl-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.LNodeP", "lnodep-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Tag", "tagKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.ExtP", "pimextp"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.ExtMngdInst", "extmngd"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.ExtP", "bgpExtP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.InstP", "instP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsEctx", "rsectx"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.ExtEncapAllocator", "encap-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.CtxUpdater", "ctx-"))
    ...
    meta.superClasses.add("cobra.model.extnw.Out")
    ...
    prop = PropMeta("str", "annotation", "annotation", 37605, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "enforceRtctrl", "enforceRtctrl", 18035, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39744, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14207, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6866, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
