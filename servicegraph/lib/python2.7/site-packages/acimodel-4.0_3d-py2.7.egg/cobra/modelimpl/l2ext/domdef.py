...
class DomDef(Mo):
    ...
    meta = ClassMeta("cobra.model.l2ext.DomDef")

    meta.moClassName = "l2extDomDef"
    meta.rnFormat = "l2dom-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L2 Domain Profile Definition"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14201, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6835, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
