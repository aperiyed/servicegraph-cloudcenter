...
class CtxPTask(Mo):
    """
    Context-level PIM policy task.

    """

    meta = ClassMeta("cobra.model.pim.CtxPTask")

    meta.moClassName = "pimCtxPTask"
    meta.rnFormat = "pimCtxPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 25523, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("releaseMcastGipoAddr", "releasemcastgipoaddr", 2244)
    prop._addConstant("requestMcastGipoAddr", "requestmcastgipoaddr", 2243)
