...
# ##################################################
class SystemClearEpLTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.top.SystemClearEpLTask")

    meta.moClassName = "topSystemClearEpLTask"
    meta.rnFormat = "topSystemClearEpLTask"
    ...
    prop = PropMeta("str", "annotation", "annotation", 42316, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 42317, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "peerClassId", "peerClassId", 42314, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12278
    prop.defaultValueStr = "topSystemClearEpRslt"
    ...
    prop = PropMeta("str", "rogue", "rogue", 42312, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "type", "type", 42315, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
