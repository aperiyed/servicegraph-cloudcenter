...
class RsCtxToEpP(Mo):
    """
    A source relation to an abstract representation of the resolvable endpoint profile. This is an internal object.

    """

    meta = SourceRelationMeta("cobra.model.l3.RsCtxToEpP", "cobra.model.fv.AREpP")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "l3RsCtxToEpP"
    meta.rnFormat = "rsctxToEpP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 15147, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 12815, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12814, PropCategory.REGULAR)
