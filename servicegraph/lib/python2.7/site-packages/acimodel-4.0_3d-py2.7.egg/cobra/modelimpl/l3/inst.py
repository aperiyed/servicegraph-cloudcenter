...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.l3.Inst")

    meta.moClassName = "l3Inst"
    meta.rnFormat = "inst-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Overlay Instance"
    meta.writeAccessMask = 0x400000000001
    meta.readAccessMask = 0x709401002001
    ...
    meta.childClasses.add("cobra.model.tunnel.LSite")
    meta.childClasses.add("cobra.model.l3.LbRtdIf")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.topoctrl.ShardChP")
    meta.childClasses.add("cobra.model.tunnel.PfxEntry")
    meta.childClasses.add("cobra.model.dci.LocalSite")
    meta.childClasses.add("cobra.model.svccopy.SvcDb")
    meta.childClasses.add("cobra.model.mgmt.RtdMgmtIf")
    meta.childClasses.add("cobra.model.tunnel.CtrlPfxEntry")
    ...
    meta.childClasses.add("cobra.model.mp.PeerNodeInfo")
    meta.childClasses.add("cobra.model.tunnel.Ctx")
    meta.childClasses.add("cobra.model.epm.Db")
    meta.childClasses.add("cobra.model.mp.PodExtn")
    meta.childClasses.add("cobra.model.fmcast.Tree")
    meta.childClasses.add("cobra.model.tunnel.RLTepPool")
    meta.childClasses.add("cobra.model.dci.RemoteSite")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3.RtEPgDefToL3Dom", "rtfvEPgDefToL3Dom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mp.PeerNodeInfo", "peerNodeInfo-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dci.RemoteSite", "remoteSite-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.dci.LocalSite", "localSite-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3.EncRtdIf", "encrtd-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mp.PodExtn", "podextn"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tunnel.LSite", "lsite-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.topoctrl.ShardChP", "shchp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.svccopy.SvcDb", "svcdb-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tunnel.Ctx", "tunctx"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tunnel.RLTepPool", "rltep-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mgmt.RtdMgmtIf", "mgmt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tunnel.CtrlPfxEntry", "cpfx-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fmcast.Tree", "tree-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tunnel.PfxEntry", "pfx-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14567, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 6846, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
