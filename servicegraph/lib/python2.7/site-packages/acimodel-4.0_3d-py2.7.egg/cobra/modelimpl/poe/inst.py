...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.poe.Inst")

    meta.moClassName = "poeInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "POE Instance"
    ...
    meta.childClasses.add("cobra.model.poe.If")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.poe.If", "if-"))
    ...
    prop = PropMeta("str", "consumption", "consumption", 32666, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 42507, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pwrCtrl", "pwrCtrl", 32667, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "totalAvail", "totalAvail", 47399, PropCategory.REGULAR)
    prop.label = "Total Avail in milliwatts"
    prop.isOper = True
    meta.props.add("totalAvail", prop)

    prop = PropMeta("str", "totalFree", "totalFree", 45739, PropCategory.REGULAR)
    prop.label = "Total Free in milliwatts"
    prop.isOper = True
    meta.props.add("totalFree", prop)
