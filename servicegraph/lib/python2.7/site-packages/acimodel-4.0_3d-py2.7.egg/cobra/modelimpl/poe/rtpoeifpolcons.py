...
# ##################################################
class RtPoeIfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.poe.RtPoeIfPolCons", "cobra.model.l1.EthIf")

    meta.moClassName = "poeRtPoeIfPolCons"
    meta.rnFormat = "rtl1PoeIfPolCons-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 34077, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 34076, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 34090, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
