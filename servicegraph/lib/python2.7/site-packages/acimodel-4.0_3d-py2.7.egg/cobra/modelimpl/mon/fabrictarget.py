...
class FabricTarget(Mo):
    ...
    prop = PropMeta("str", "annotation", "annotation", 37292, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39431, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop._addConstant("aaaAppUser", "app-user-(aaa.appuser)", 9534)
    prop._addConstant("aaaCtrlrFipsState", "to-fix---aaa.ctrlrfipsstate", 9413)
    ...
    prop._addConstant("aaaRsaEp", "default-rsa-authentication-settings-(aaa.rsaep)", 10967)
    prop._addConstant("aaaRsaProvider", "rsa-provider-(aaa.rsaprovider)", 10968)
    prop._addConstant("aaaSamlEncCert", "key-pair-for-saml-encryption-(aaa.samlenccert)", 11975)
    prop._addConstant("aaaSamlEp", "default-saml-authentication-settings-(aaa.samlep)", 10636)
    prop._addConstant("aaaSamlProvider", "saml-provider-(aaa.samlprovider)", 10637)
    prop._addConstant("aaaSecRelnHolder", "security-relations-holder-(aaa.secrelnholder)", 1515)
    ...
    prop._addConstant("aaaUserCert", "x509-certificate-(aaa.usercert)", 1498)
    ...
    prop._addConstant("acLatencyInst", "latency-instance-(ac.latencyinst)", 9357)
    ...
    prop._addConstant("analyticsBDTarget", "bd-instance-target-(analytics.bdtarget)", 9035)
    prop._addConstant("analyticsCollector", "collector-entry-(analytics.collector)", 9021)
    prop._addConstant("analyticsCollectorBucket", "flow-collector-bucket-entry-(analytics.collectorbucket)", 9024)
    prop._addConstant("analyticsController", "controller-reachability-(analytics.controller)", 9019)
    prop._addConstant("analyticsEntity", "entity-(analytics.entity)", 8272)
    prop._addConstant("analyticsFwdInstTarget", "forward-instance-target-(analytics.fwdinsttarget)", 8289)
    prop._addConstant("analyticsInst", "netflow-instance-(analytics.inst)", 9017)
    prop._addConstant("analyticsMonitor", "flow-monitor-(analytics.monitor)", 8275)
    prop._addConstant("analyticsPhysIfTarget", "interface-instance-target-(analytics.physiftarget)", 9034)
    prop._addConstant("analyticsRecordP", "flow-record-(analytics.recordp)", 9020)
    prop._addConstant("analyticsRsCollectorAtt", "reference-to-collector-(analytics.rscollectoratt)", 9025)
    prop._addConstant("analyticsRsMonitorAtt", "reference-to-monitor-(analytics.rsmonitoratt)", 9030)
    prop._addConstant("analyticsRsPolicyAtt", "reference-to-policy-(analytics.rspolicyatt)", 9528)
    prop._addConstant("analyticsRsProfAtt", "reference-to-profile-(analytics.rsprofatt)", 9032)
    prop._addConstant("analyticsRsRecordPAtt", "record-policy-attachment-(analytics.rsrecordpatt)", 9022)
    ...
    prop._addConstant("bfdSessStats", "bfd-session-stats-(bfd.sessstats)", 5770)
    ...
    prop._addConstant("bgpExtIntersiteRRP", "route-reflector-profile-(bgp.extintersiterrp)", 9835)
    prop._addConstant("bgpExtRRP", "route-reflector-profile-(bgp.extrrp)", 7222)
    ...
    prop._addConstant("callhomeDestReachState", "callhome-destination-state-(callhome.destreachstate)", 9424)
    ...
    prop._addConstant("callhomeSmartDest", "smart-callhome-destination-(callhome.smartdest)", 11770)
    prop._addConstant("callhomeSmartGroup", "smart-callhome-destination-group-(callhome.smartgroup)", 11772)
    ...
    prop._addConstant("cloudsecKeyStCont", "key-status-container-(cloudsec.keystcont)", 12925)
    ...
    prop._addConstant("cloudsecSiteRxKeySt", "aggregated-rxsakey-status-on-site-(cloudsec.siterxkeyst)", 12929)
    prop._addConstant("cloudsecSiteTxKeySt", "aggregated-txsakey-status-on-site-(cloudsec.sitetxkeyst)", 12932)
    ...
    prop._addConstant("commRsClientCertCA", "tp-(comm.rsclientcertca)", 12375)
    ...
    prop._addConstant("configDumpP", "configuration-export-policy-from-pd-(config.dumpp)", 10987)
    ...
    prop._addConstant("coppFilter", "filter-entry-(copp.filter)", 10159)
    prop._addConstant("coppIf", "copp-interface-(copp.if)", 10157)
    prop._addConstant("coppRule", "class-(copp.rule)", 10158)
    ...
    prop._addConstant("dhcpRelayAddr", "relay-address-(dhcp.relayaddr)", 2677)
    ...
    prop._addConstant("dhcpServerInfo", "vtor-dhcp-server-info-(dhcp.serverinfo)", 15137)
    ...
    prop._addConstant("dot1xNic", "dot1x-nic-class-(dot1x.nic)", 10710)
    prop._addConstant("dot1xVDAEp", "interface-(dot1x.vdaep)", 10688)
    prop._addConstant("dppCkt", "vlan/vxlan-cktep-(dpp.ckt)", 10574)
    ...
    prop._addConstant("eqptBrkoutPortP", "breakout-port-policy-(eqpt.brkoutportp)", 8438)
    ...
    prop._addConstant("eqptFeatureEx", "feature-exclusion-(eqpt.featureex)", 11720)
    ...
    prop._addConstant("eqptPortP", "port-policy-(eqpt.portp)", 11003)
    ...
    prop._addConstant("eqptReloadSwitch", "reload-switch-(eqpt.reloadswitch)", 11377)
    prop._addConstant("eqptSensor", "equipment-sensor-(eqpt.sensor)", 3255)
    prop._addConstant("eqptSlotP", "slot-policy-(eqpt.slotp)", 3347)
    ...
    prop._addConstant("extdevDomainCont", "container-for-domain-relations-(extdev.domaincont)", 12676)
    prop._addConstant("extdevGroupP", "edm-group-(extdev.groupp)", 12672)
    prop._addConstant("extdevMgrP", "edm-controller-(extdev.mgrp)", 12673)
    prop._addConstant("extdevNicProf", "nic-profile-(extdev.nicprof)", 12680)
    prop._addConstant("extdevRsDomDef", "relation-to-domp-(extdev.rsdomdef)", 12677)
    prop._addConstant("extdevRsNicProfToDomP", "relation-to-domp-(extdev.rsnicproftodomp)", 12681)
    prop._addConstant("extdevUplinkProf", "uplink-profile-(extdev.uplinkprof)", 12679)
    prop._addConstant("fabricAssociatedSetupP", "pod-subnets-in-addition-to-setupp-(fabric.associatedsetupp)", 13101)
    ...
    prop._addConstant("fabricExtRoutableMcastIp", "multicast-tep-(fabric.extroutablemcastip)", 13112)
    prop._addConstant("fabricExtRoutableNodeDef", "ext-routable-node-definition-(fabric.extroutablenodedef)", 13113)
    prop._addConstant("fabricExtRoutableNodeIp", "assigned-external-routable-ip-to-a-node-(fabric.extroutablenodeip)", 13110)
    prop._addConstant("fabricExtRoutablePodSubnet", "pod-subnets-in-addition-to-setupp-(fabric.extroutablepodsubnet)", 13102)
    prop._addConstant("fabricExtRoutablePodSubnetCont", "alocated-external-routable-ip-address-holder-(fabric.extroutablepodsubnetcont)", 13103)
    prop._addConstant("fabricExtRoutableSubnetCont", "external-routable-subnet-holder-(fabric.extroutablesubnetcont)", 13099)
    prop._addConstant("fabricExtRoutableUcastIp", "ucast-tep-(fabric.extroutableucastip)", 13111)
    prop._addConstant("fabricExtSetupP", "fabric-setup-policy-for-a-external-site-(fabric.extsetupp)", 11015)
    ...
    prop._addConstant("fabricLeBrkoutPortGrp", "leaf-fabric-breakout-port-group-(fabric.lebrkoutportgrp)", 9347)
    ...
    prop._addConstant("fabricLocale", "fabric-locale-(fabric.locale)", 1008)
    ...
    prop._addConstant("fabricOLeafS", "override-leaf-selector-(fabric.oleafs)", 8992)
    prop._addConstant("fabricOOServicePol", "out-of-service-fabric-policy-(fabric.ooservicepol)", 671)
    prop._addConstant("fabricOSpineS", "override-spine-selector-(fabric.ospines)", 8989)
    ...
    prop._addConstant("fabricPodTaskHolder", "pod-task-holder-(fabric.podtaskholder)", 11086)
    ...
    prop._addConstant("fabricRsDwdmFabIfPol", "dwdm-fiber-optics-channel-policy-(fabric.rsdwdmfabifpol)", 11326)
    ...
    prop._addConstant("fabricRsL3IfPol", "l3-interface-policy-(fabric.rsl3ifpol)", 10733)
    ...
    prop._addConstant("fabricRsMacsecFabIfPol", "macsec-policy-(fabric.rsmacsecfabifpol)", 9869)
    prop._addConstant("fabricRsMacsecPol", "macsec-policy-(fabric.rsmacsecpol)", 9871)
    ...
    prop._addConstant("fabricRsNodeCfgSrv", "analytics-config-server-policy-(fabric.rsnodecfgsrv)", 8178)
    prop._addConstant("fabricRsNodeCoreP", "tech-support-policy-(fabric.rsnodecorep)", 917)
    prop._addConstant("fabricRsNodeCtrl", "digital-optical-monitoring-policy-(fabric.rsnodectrl)", 8938)
    prop._addConstant("fabricRsNodeFlowServers", "telemetry-policy-(fabric.rsnodeflowservers)", 11356)
    prop._addConstant("fabricRsNodeGroup", "group-of-fabric-nodes-(fabric.rsnodegroup)", 5278)
    prop._addConstant("fabricRsNodeOverride", "super-class-for-relation-from-node-to-fabric-policies-deployed-on-node-(fabric.rsnodeoverride)", 8995)
    ...
    prop._addConstant("fabricRsOLeafSToLeNodePGrp", "leaf-node-policy-group-(fabric.rsoleafstolenodepgrp)", 8993)
    prop._addConstant("fabricRsOSpineSToSpNodePGrp", "spine-node-policy-group-(fabric.rsospinestospnodepgrp)", 8990)
    prop._addConstant("fabricRsOosPath", "out-of-service-fabric-path-(fabric.rsoospath)", 674)
    prop._addConstant("fabricRsOosSlot", "out-of-service-slot-(fabric.rsoosslot)", 5550)
    ...
    prop._addConstant("fabricRsRemoteStatsServer", "remote-telemetry-statsserver-(fabric.rsremotestatsserver)", 11341)
    ...
    prop._addConstant("fabricRsTwampResponderPol", "twamp-responder-policy-(fabric.rstwampresponderpol)", 11778)
    prop._addConstant("fabricRsTwampServerPol", "twamp-server-policy-(fabric.rstwampserverpol)", 11776)
    ...
    prop._addConstant("fabricSetupP", "fabric-setup-policy-for-a-pod-(fabric.setupp)", 7235)
    prop._addConstant("fabricSetupPol", "fabric-firsttime-setup-policy-(fabric.setuppol)", 7234)
    prop._addConstant("fabricShardTaskHolder", "node-task-holder-(fabric.shardtaskholder)", 5272)
    prop._addConstant("fabricSpBrkoutPortGrp", "spine-fabric-breakout-port-group-(fabric.spbrkoutportgrp)", 9348)
    ...
    prop._addConstant("fabricVmmDecommissionJob", "decommission-job-(fabric.vmmdecommissionjob)", 11695)
    prop._addConstant("faultSevAsnP", "fault-severity-assignment-policy-(fault.sevasnp)", 1733)
    prop._addConstant("fcDomP", "fc-domain-(fc.domp)", 8727)
    prop._addConstant("fcEncapInstDef", "vsan-encap-namespace-(fc.encapinstdef)", 8741)
    prop._addConstant("fcEntity", "entity-object-(fc.entity)", 8447)
    prop._addConstant("fcRsVsanAttr", "relation-to-vsan-attributes-(fc.rsvsanattr)", 8728)
    prop._addConstant("fcRsVsanNs", "relation-to-vsan-pool-(fc.rsvsanns)", 9006)
    prop._addConstant("fcpmFcAggrIf", "aggregated-interface-(fcpm.fcaggrif)", 11919)
    prop._addConstant("fcpmFcPhysIf", "physical-interface-runtime-state-(fcpm)-(fcpm.fcphysif)", 13612)
    prop._addConstant("fcpmFcot", "fcot-(fcpm.fcot)", 11923)
    prop._addConstant("fcpmFcotX2", "x2-fcot-(fcpm.fcotx2)", 11925)
    prop._addConstant("fhsBD", "layer-2-bridge-domain-(fhs.bd)", 9253)
    prop._addConstant("fhsCktEp", "epg-circuit-(fhs.cktep)", 9259)
    prop._addConstant("fhsDom", "fhs-layer-3-domain-(fhs.dom)", 9789)
    prop._addConstant("fhsEntity", "entity-(fhs.entity)", 9260)
    prop._addConstant("fhsInst", "instance-(fhs.inst)", 9261)
    prop._addConstant("fhsIpInspect", "ip-inspection-policy-(fhs.ipinspect)", 9254)
    prop._addConstant("fhsIpInspectProto", "inspection-protocol-policy-(fhs.ipinspectproto)", 9255)
    prop._addConstant("fhsRaGuard", "ra-guard-policy-(fhs.raguard)", 9256)
    prop._addConstant("fhsSrcGuard", "source-guard-policy-(fhs.srcguard)", 9258)
    prop._addConstant("fhsTrustCtrl", "trust-control-policy-(fhs.trustctrl)", 9252)
    prop._addConstant("fhsViolationEvent", "violation-event-(fhs.violationevent)", 10536)
    ...
    prop._addConstant("fvVNode", "vleaf-node-(fv.vnode)", 2070)
    ...
    prop._addConstant("fvnsMcastAddrBlk", "abstraction-of-ip-address-block-(fvns.mcastaddrblk)", 4554)
    ...
    prop._addConstant("fvnsVsanInstP", "vsan-pool-(fvns.vsaninstp)", 8785)
    ...
    prop._addConstant("hostprotPolDef", "host-protection-domain-policy-(hostprot.poldef)", 9838)
    prop._addConstant("hostprotRuleDef", "host-protection-domain-rule-(hostprot.ruledef)", 9844)
    prop._addConstant("hostprotSubjDef", "host-protection-domain-subject-(hostprot.subjdef)", 9841)
    prop._addConstant("hsrpAddr", "hsrp-secondary-vip-(hsrp.addr)", 8368)
    prop._addConstant("hsrpDom", "domain-(hsrp.dom)", 8373)
    prop._addConstant("hsrpEntity", "hsrp-entity-(hsrp.entity)", 8370)
    prop._addConstant("hsrpGroupV1", "hsrp-group-(hsrp.groupv1)", 8377)
    prop._addConstant("hsrpGroupV2", "hsrp-group-(hsrp.groupv2)", 8372)
    prop._addConstant("hsrpIf", "hsrp-interface-(hsrp.if)", 8375)
    prop._addConstant("hsrpInst", "hsrp-instance-(hsrp.inst)", 8371)
    prop._addConstant("iaclEntry", "acl-entry-of-the-copp-prefilter-(iacl.entry)", 10977)
    prop._addConstant("iaclLeafProfile", "profiles-for-copp-prefilter-to-be-applied-at-the-leaf-level-(iacl.leafprofile)", 10975)
    prop._addConstant("iaclSpineProfile", "profiles-for-copp-prefilter-to-be-applied-at-the-spine-level-(iacl.spineprofile)", 10976)
    prop._addConstant("igmpDom", "igmp-domain-(igmp.dom)", 8388)
    prop._addConstant("igmpEntity", "igmp-entity-(igmp.entity)", 6959)
    prop._addConstant("igmpIf", "igmp-interface-(igmp.if)", 8390)
    prop._addConstant("igmpInst", "igmp-instance-(igmp.inst)", 6960)
    prop._addConstant("igmpResP", "resource-policy-(igmp.resp)", 8387)
    prop._addConstant("igmpStRepP", "static-report-policy-(igmp.strepp)", 8396)
    prop._addConstant("igmpsnoopDom", "igmp-snooping-domain-(igmpsnoop.dom)", 2710)
    ...
    prop._addConstant("igmpsnoopQuerierSt", "querier-state-(igmpsnoop.querierst)", 2713)
    ...
    prop._addConstant("infraAccPortGrp", "leaf-access-port-policy-group-(infra.accportgrp)", 4409)
    prop._addConstant("infraAccPortP", "leaf-interface-profile-(infra.accportp)", 4367)
    ...
    prop._addConstant("infraBrkoutPortGrp", "leaf-breakout-port-group-(infra.brkoutportgrp)", 9141)
    ...
    prop._addConstant("infraFcAccBndlGrp", "leaf-access-fc-pc-policy-group-(infra.fcaccbndlgrp)", 11873)
    prop._addConstant("infraFcAccBndlPolGrp", "leaf-access-fc-pc-policy-override-group-(infra.fcaccbndlpolgrp)", 11874)
    prop._addConstant("infraFcAccPortGrp", "leaf-access-fc-port-policy-group-(infra.fcaccportgrp)", 11872)
    ...
    prop._addConstant("infraNodeP", "leaf-profile-(infra.nodep)", 4361)
    prop._addConstant("infraNsIssues", "access-namespace-configuration-issues-(infra.nsissues)", 4523)
    prop._addConstant("infraOLeafS", "override-leaf-selector-(infra.oleafs)", 9001)
    ...
    prop._addConstant("infraPortDirecPol", "port-status-infra-policy-(infra.portdirecpol)", 11004)
    ...
    prop._addConstant("infraRsCoppIfPol", "relation-to-per-interface-per-protocol-copp-policy-(infra.rscoppifpol)", 9905)
    prop._addConstant("infraRsDomP", "domain-(infra.rsdomp)", 4442)
    prop._addConstant("infraRsDwdmIfPol", "dwdm-fiber-optics-channel-policy-(infra.rsdwdmifpol)", 11331)
    prop._addConstant("infraRsFabricNode", "fabric-node-(infra.rsfabricnode)", 5244)
    prop._addConstant("infraRsFcAttEntP", "relation-to-access-attach-entity-policy-(infra.rsfcattentp)", 11865)
    prop._addConstant("infraRsFcFabricPol", "fibre-channel-fabric-level-policy-(infra.rsfcfabricpol)", 8764)
    prop._addConstant("infraRsFcIfPol", "interface-fc-policy-(infra.rsfcifpol)", 9059)
    prop._addConstant("infraRsFcInstPol", "fibre-channel-instance-policy-(infra.rsfcinstpol)", 8766)
    prop._addConstant("infraRsFcL2IfPol", "relation-to-l2-fc-interface-policy-(infra.rsfcl2ifpol)", 11863)
    prop._addConstant("infraRsFcLagPol", "relation-to-link-aggregation-interface-policy-(infra.rsfclagpol)", 11868)
    ...
    prop._addConstant("infraRsIaclLeafProfile", "copp-prefilter-profile-for-leafs-(infra.rsiaclleafprofile)", 10972)
    prop._addConstant("infraRsIaclSpineProfile", "copp-prefilter-profile-for-spines-(infra.rsiaclspineprofile)", 10970)
    prop._addConstant("infraRsInfraNodeOverride", "super-class-for-relation-from-node-to-fabric-policies-deployed-on-node-(infra.rsinfranodeoverride)", 9004)
    prop._addConstant("infraRsInterfacePolProfile", "leaf-interface-profile-(infra.rsinterfacepolprofile)", 4347)
    ...
    prop._addConstant("infraRsL2NodeAuthPol", "node-authentication-(802.1x)-policy-(infra.rsl2nodeauthpol)", 10741)
    prop._addConstant("infraRsL2PortAuthPol", "interface-authentication-(802.1x)-policy-(infra.rsl2portauthpol)", 10661)
    prop._addConstant("infraRsL2PortSecurityPol", "relation-to-l2-portsecurity-policy-(infra.rsl2portsecuritypol)", 8952)
    ...
    prop._addConstant("infraRsLeafCoppProfile", "copp-profile-for-leafs-(infra.rsleafcoppprofile)", 10006)
    prop._addConstant("infraRsLldpIfPol", "relation-to-lldp-interface-policy-(infra.rslldpifpol)", 4390)
    prop._addConstant("infraRsMacsecIfPol", "relation-to-macsec-interface-policy-(infra.rsmacsecifpol)", 9894)
    ...
    prop._addConstant("infraRsMonBrkoutInfraPol", "relation-to-breakout-infra-monitoring-policy-(infra.rsmonbrkoutinfrapol)", 9142)
    ...
    prop._addConstant("infraRsNetflowMonitorPol", "relation-to-netflow-monitor-policy-(infra.rsnetflowmonitorpol)", 9237)
    prop._addConstant("infraRsNetflowNodePol", "netflow-node-policy-(infra.rsnetflownodepol)", 9235)
    prop._addConstant("infraRsNodeP", "to-node-profile-(infra.rsnodep)", 7049)
    prop._addConstant("infraRsNodePolGroup", "super-class-for-relation-from-node-to-fabric-policies-deployed-on-node-(infra.rsnodepolgroup)", 4343)
    prop._addConstant("infraRsOLeafSToAccNodePGrp", "relation-to-node-policy-group-(infra.rsoleafstoaccnodepgrp)", 9002)
    ...
    prop._addConstant("infraRsPathToSpAccGrp", "access-base-group-(infra.rspathtospaccgrp)", 8247)
    prop._addConstant("infraRsPoeIfPol", "relation-to-poe-interface-policy-(infra.rspoeifpol)", 10936)
    prop._addConstant("infraRsPoeInstPol", "poe-node-policy-(infra.rspoeinstpol)", 10934)
    prop._addConstant("infraRsPortDirection", "port-direction-(infra.rsportdirection)", 11005)
    prop._addConstant("infraRsQosDppIfPol", "data-plane-policy-both-(infra.rsqosdppifpol)", 7766)
    ...
    prop._addConstant("infraRsQosPfcIfPol", "interface-priority-flow-control-(infra.rsqospfcifpol)", 8768)
    prop._addConstant("infraRsQosSdIfPol", "slow-drain-policy-(infra.rsqossdifpol)", 8820)
    ...
    prop._addConstant("infraRsSpAccGrp", "spine-access-group-(infra.rsspaccgrp)", 8235)
    prop._addConstant("infraRsSpAccPortP", "interface-profile-(infra.rsspaccportp)", 8238)
    ...
    prop._addConstant("infraRsSpineAccNodePGrp", "relation-to-node-policy-group-(infra.rsspineaccnodepgrp)", 10008)
    prop._addConstant("infraRsSpineBfdIpv4InstPol", "bfd-ipv4-instance-policy-(infra.rsspinebfdipv4instpol)", 10999)
    prop._addConstant("infraRsSpineBfdIpv6InstPol", "bfd-ipv6-instance-policy-(infra.rsspinebfdipv6instpol)", 11001)
    prop._addConstant("infraRsSpineCoppProfile", "copp-profile-for-spines-(infra.rsspinecoppprofile)", 10004)
    ...
    prop._addConstant("infraRsToInterfacePolProfile", "leaf-interface-profile-(infra.rstointerfacepolprofile)", 7475)
    prop._addConstant("infraRsToInterfaceSpPolProfile", "spine-interface-profile-(infra.rstointerfacesppolprofile)", 8251)
    ...
    prop._addConstant("infraRsToVsanAttr", "vsan-attributes-(infra.rstovsanattr)", 8762)
    prop._addConstant("infraRsToVsanEncapInstDef", "vsan-encap-namespace-(infra.rstovsanencapinstdef)", 8760)
    prop._addConstant("infraRsTopoctrlFastLinkFailoverInstPol", "fast-link-failover-instance-policy-(infra.rstopoctrlfastlinkfailoverinstpol)", 11271)
    prop._addConstant("infraRsTopoctrlFwdScaleProfPol", "forwarding-scale-profile-policy-(infra.rstopoctrlfwdscaleprofpol)", 10642)
    ...
    prop._addConstant("infraSHPathS", "host-path-selector-(infra.shpaths)", 8244)
    prop._addConstant("infraSHPortS", "spine-access-port-selector-(infra.shports)", 8234)
    ...
    prop._addConstant("infraSpAccPortGrp", "spine-access-port-policy-group-(infra.spaccportgrp)", 8243)
    prop._addConstant("infraSpAccPortP", "spine-interface-profile-(infra.spaccportp)", 8240)
    prop._addConstant("infraSpineAccNodePGrp", "spine-switch-policy-group-(infra.spineaccnodepgrp)", 10003)
    prop._addConstant("infraSpineP", "spine-profile-(infra.spinep)", 8237)
    prop._addConstant("infraSpineS", "switch-association-(infra.spines)", 8233)
    ...
    prop._addConstant("ipv4L3AnycastEP", "anycast-endpoint-(ipv4.l3anycastep)", 11813)
    prop._addConstant("ipv4Nexthop", "ipv4-nexthop-(ipv4.nexthop)", 3796)
    prop._addConstant("ipv4NexthopEP", "ipv4-nexthopep-(ipv4.nexthopep)", 10744)
    prop._addConstant("ipv4Route", "ipv4-static-route-(ipv4.route)", 3795)
    prop._addConstant("ipv4RouteEP", "ipv4-static-route-endpoint-(ipv4.routeep)", 10743)
    ...
    prop._addConstant("ipv6L3AnycastEP", "anycast-endpoint-(ipv6.l3anycastep)", 11812)
    prop._addConstant("ipv6Nexthop", "ipv6-nexthop-(ipv6.nexthop)", 3595)
    prop._addConstant("ipv6NexthopEP", "ipv6-nexthopep-(ipv6.nexthopep)", 10748)
    prop._addConstant("ipv6Route", "ipv6-static-route-(ipv6.route)", 3594)
    prop._addConstant("ipv6RouteEP", "ipv6-static-routeep-(ipv6.routeep)", 10747)
    ...
    prop._addConstant("isisExtIf", "is-is-interface-(isis.extif)", 6961)
    ...
    prop._addConstant("kcEntry", "key-chain-(kc.entry)", 9933)
    prop._addConstant("kcMACSecKey", "mac-security-key-(kc.macseckey)", 9935)
    prop._addConstant("l1FcPhysIf", "layer-1-fc-physical-interface-configuration-(l1.fcphysif)", 11908)
    ...
    prop._addConstant("l1VethIf", "virtual-ethernet-interface-config-(l1.vethif)", 11917)
    ...
    prop._addConstant("l2FcAggrIf", "san-port-channel-interface-(l2.fcaggrif)", 11898)
    prop._addConstant("l2FcBrIf", "physical-fiber-channel-interface-(l2.fcbrif)", 11895)
    prop._addConstant("l2InbandIf", "layer2-inband-interface-(l2.inbandif)", 3397)
    prop._addConstant("l2NodeAuthPol", "802.1x-node-authentication-policy-(l2.nodeauthpol)", 10740)
    prop._addConstant("l2PortSecurityPolDef", "port-security-policy-(l2.portsecuritypoldef)", 9101)
    prop._addConstant("l2RsAaaRadiusProviderGroup", "radius-provider-group-policy-(l2.rsaaaradiusprovidergroup)", 10659)
    prop._addConstant("l2RsSrvExtIfMap", "server-to-external-interface-mapping-(l2.rssrvextifmap)", 8461)
    prop._addConstant("l2TrafficMapConfIssue", "trafiic-map-configure-issue-(l2.trafficmapconfissue)", 13201)
    prop._addConstant("l2VfcIf", "virtual-fibre-channel-interface-(l2.vfcif)", 8460)
    ...
    prop._addConstant("latencyOnGoingCont", "container-for-on-going-latency-numbers-(latency.ongoingcont)", 9817)
    prop._addConstant("latencyPath", "on-going-path-latency-data-(latency.path)", 9819)
    prop._addConstant("latencyPtpMode", "precision-time-protocol-enabled/disabled-(latency.ptpmode)", 9802)
    ...
    prop._addConstant("macsecFabIfPol", "macsec-fabric-interface-policy-(macsec.fabifpol)", 9883)
    prop._addConstant("macsecFabParamPol", "macsec-fabric-parameters-policy-(macsec.fabparampol)", 9887)
    prop._addConstant("macsecFabPolCont", "macsec-fabric-policy-container-(macsec.fabpolcont)", 9875)
    prop._addConstant("macsecIf", "macsec-interface-(macsec.if)", 9901)
    prop._addConstant("macsecIfPol", "macsec-access-interface-policy-(macsec.ifpol)", 9882)
    prop._addConstant("macsecInst", "macsec-instance-(macsec.inst)", 9899)
    prop._addConstant("macsecKeyChainPol", "macsec-keychain-policy-(macsec.keychainpol)", 9891)
    prop._addConstant("macsecKeyPol", "macsec-key-policy-(macsec.keypol)", 9893)
    prop._addConstant("macsecParamPol", "macsec-access-parameters-policy-(macsec.parampol)", 10696)
    prop._addConstant("macsecPolCont", "macsec-access-policy-container-(macsec.polcont)", 9874)
    prop._addConstant("macsecRsToKeyChainPol", "source-to-keychain-relation-(macsec.rstokeychainpol)", 9879)
    prop._addConstant("macsecRsToParamPol", "source-to-ifpol-relation-(macsec.rstoparampol)", 9877)
    ...
    prop._addConstant("ndDom", "neighbor-discovery-domain-(nd.dom)", 2644)
    prop._addConstant("ndEntity", "neighbor-discover-entity-(nd.entity)", 2642)
    prop._addConstant("ndIf", "neighbor-discovery-interface-(nd.if)", 2641)
    prop._addConstant("ndInst", "neighbor-discovery-instance-(nd.inst)", 2643)
    prop._addConstant("ndStAdjEp", "nd-static-adjacency-(nd.stadjep)", 5782)
    ...
    prop._addConstant("opflexODevFaultInfo", "concrete-class-to-raise-faults-for-odev-issues-(opflex.odevfaultinfo)", 8818)
    ...
    prop._addConstant("opflexpVmmODevFaultInfo", "concrete-class-to-raise-faults-for-odev-issues-in-vpod-ave-(opflexp.vmmodevfaultinfo)", 12918)
    ...
    prop._addConstant("ospfIfStats", "ifstats-(ospf.ifstats)", 2647)
    ...
    prop._addConstant("pcFcAggrIf", "fc-aggregated-interface-(pc.fcaggrif)", 11909)
    prop._addConstant("pcFcAggrMbrIf", "aggregated-member-interface-(pc.fcaggrmbrif)", 11914)
    prop._addConstant("pcRsFcMbrIfs", "layer-1-fc-physical-interface-configuration-(pc.rsfcmbrifs)", 11910)
    prop._addConstant("physDomP", "physical-domain-(phys.domp)", 1809)
    prop._addConstant("pimDom", "pim-domain-(pim.dom)", 8404)
    prop._addConstant("pimEntity", "pim-entity-(pim.entity)", 8426)
    prop._addConstant("pimInst", "pim-instance-(pim.inst)", 8427)
    ...
    prop._addConstant("pkiEp", "public-key-management-(pki.ep)", 1478)
    ...
    prop._addConstant("plannerRsExistingTopoDeplPref", "deployment-filters-for-existing-topology-(planner.rsexistingtopodeplpref)", 10782)
    ...
    prop._addConstant("poeIfPol", "poe-interface-policy-(poe.ifpol)", 10931)
    prop._addConstant("poeInst", "poe-instance-(poe.inst)", 10529)
    prop._addConstant("poeNic", "poe-nic-class-(poe.nic)", 12305)
    prop._addConstant("poeRsPoeEpg", "poe-epg-(poe.rspoeepg)", 13004)
    ...
    prop._addConstant("polRsCtrlrFipsMode", "to-fix---pol.rsctrlrfipsmode", 9411)
    ...
    prop._addConstant("polRsDockerImage", "relation-to-docker-image-(pol.rsdockerimage)", 9557)
    prop._addConstant("polRsExportPRel", "export-policy-container-(pol.rsexportprel)", 4204)
    prop._addConstant("polRsFabricSelfCAEp", "relation-to-pkifabricselfcaep-(pol.rsfabricselfcaep)", 12273)
    ...
    prop._addConstant("polRsPluginPol", "relation-to-plugin-config-(pol.rspluginpol)", 9911)
    ...
    prop._addConstant("polRsVnsmdfctcat", "relation-to-l4-l7-service-defect-category-(pol.rsvnsmdfctcat)", 9240)
    prop._addConstant("polUni", "policy-universe-(pol.uni)", 4602)
    prop._addConstant("procApp", "application-process-entry-(proc.app)", 9946)
    prop._addConstant("procContainer", "container-(proc.container)", 9945)
    ...
    prop._addConstant("quotaConf", "quota-configuration-(quota.conf)", 9537)
    prop._addConstant("quotaCont", "container-for-quota-configuration-(quota.cont)", 9536)
    prop._addConstant("radiusEntity", "radius-entity-(radius.entity)", 10623)
    prop._addConstant("radiusInst", "instance-(radius.inst)", 10624)
    prop._addConstant("radiusServerHost", "server-host-(radius.serverhost)", 10627)
    ...
    prop._addConstant("rpmEntity", "route-policy-map-entity-(rpm.entity)", 3549)
    ...
    prop._addConstant("spanRsSpanSrcToL3OutAtt", "relation-to-l3-out-interface-(span.rsspansrctol3outatt)", 11787)
    ...
    prop._addConstant("stpInstPol", "spanning-tree-policy-(stp.instpol)", 564)
    prop._addConstant("stpMstDomPol", "spanning-tree-domain-policy-(stp.mstdompol)", 566)
    prop._addConstant("stpMstRegionPol", "spanning-tree-policy-region-(stp.mstregionpol)", 565)
    prop._addConstant("svccopyDest", "copy-destination-(svccopy.dest)", 7462)
    prop._addConstant("svccopyEntity", "entity-(svccopy.entity)", 7463)
    prop._addConstant("svccopyInst", "control-plane-instance-(svccopy.inst)", 7464)
    ...
    prop._addConstant("svcredirDest", "redirect-destination-(svcredir.dest)", 7002)
    prop._addConstant("svcredirDestGrp", "redirect-destination-(svcredir.destgrp)", 6999)
    prop._addConstant("svcredirEntity", "entity-(svcredir.entity)", 7003)
    prop._addConstant("svcredirHealthGrp", "health-group-(svcredir.healthgrp)", 10945)
    prop._addConstant("svcredirHealthGrpDest", "redirect-destination-(svcredir.healthgrpdest)", 10949)
    prop._addConstant("svcredirInst", "control-plane-instance-(svcredir.inst)", 7004)
    prop._addConstant("svcredirRsDestAtt", "redirect-destination-(svcredir.rsdestatt)", 7000)
    ...
    prop._addConstant("tacacsGroup", "tacacs-monitoring-destination-group-(tacacs.group)", 11992)
    ...
    prop._addConstant("tacacsTacacsDest", "tacacs-destination-(tacacs.tacacsdest)", 11991)
    ...
    prop._addConstant("telemetryCollectorProvider", "telemetry-collector-provider-(telemetry.collectorprovider)", 11979)
    prop._addConstant("telemetryFlowServerGrp", "telemetry-flow-server-group-(telemetry.flowservergrp)", 11749)
    prop._addConstant("telemetryLogServerGrp", "telemetry-policy-group-(telemetry.logservergrp)", 11393)
    prop._addConstant("telemetryPodLogServerGrp", "pod-maintenance-group-(telemetry.podlogservergrp)", 11390)
    prop._addConstant("telemetryProvider", "telemetry-infra-provider-(telemetry.provider)", 11374)
    prop._addConstant("telemetryRequirement", "to-fix---telemetry.requirement", 12539)
    prop._addConstant("telemetryRsToCtxDef", "association-to-inband-ctxdef-(telemetry.rstoctxdef)", 11980)
    prop._addConstant("telemetryRsToFlowServerGrp", "flow-server-group-(telemetry.rstoflowservergrp)", 11747)
    prop._addConstant("telemetryRsToFltPolGrp", "relation-to-telemetry-analytics-filter-policy-group-(telemetry.rstofltpolgrp)", 11750)
    prop._addConstant("telemetryRsToInbCtxDef", "association-to-inband-ctxdef-(telemetry.rstoinbctxdef)", 11375)
    prop._addConstant("telemetryRsToLogServerGrp", "log-group-(telemetry.rstologservergrp)", 11391)
    prop._addConstant("telemetryRsToRemoteLogServer", "relation-to-pol-group-(telemetry.rstoremotelogserver)", 11394)
    prop._addConstant("telemetryRsToRemoteStatsServer", "relation-to-pol-group-(telemetry.rstoremotestatsserver)", 11700)
    prop._addConstant("telemetryRsToStatsServerGrp", "stats-group-(telemetry.rstostatsservergrp)", 11697)
    prop._addConstant("telemetryServers", "telemetry-server-container-(telemetry.servers)", 11030)
    prop._addConstant("telemetryStatsServerGrp", "telemetry-policy-group-(telemetry.statsservergrp)", 11699)
    prop._addConstant("telemetryStatsServerP", "stats-server-info-streaming-stats-(telemetry.statsserverp)", 11347)
    prop._addConstant("topSystem", "system-(top.system)", 3)
    prop._addConstant("topoctrlEndpointControlP", "endpoint-control-policy-(topoctrl.endpointcontrolp)", 7161)
    prop._addConstant("topoctrlEntity", "topology-control-entity-(topoctrl.entity)", 2338)
    ...
    prop._addConstant("trigRoProxy", "proxy-object-for-triggering-admin-executable-policies-(trig.roproxy)", 12536)
    prop._addConstant("trigRoProxyCont", "read-only-admin-triggerable-proxy-(trig.roproxycont)", 12535)
    ...
    prop._addConstant("twampEntity", "twamp-entity-(twamp.entity)", 11780)
    prop._addConstant("twampResponderInst", "twamp-responder-instance-(twamp.responderinst)", 11782)
    prop._addConstant("twampServerInst", "twamp-server-instance-(twamp.serverinst)", 11781)
    prop._addConstant("unifiedportsEntity", "entity-object-(unifiedports.entity)", 11903)
    prop._addConstant("unifiedportsIf", "unified-port-object-(unifiedports.if)", 11904)
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("uribv4Entity", "ipv4-unicast-routing-information-base-entity-(uribv4.entity)", 3776)
    prop._addConstant("usrsyslogRecord", "user-syslog-record-(usrsyslog.record)", 9323)
    prop._addConstant("vethEntity", "container-for-virtual-ethernet-ports-(veth.entity)", 11901)
    prop._addConstant("vethInst", "veth-instance-(veth.inst)", 11902)
    ...
    prop._addConstant("vnsAdjacencyDefCont", "to-fix---vns.adjacencydefcont", 8249)
    ...
    prop._addConstant("vnsVmmConfigFile", "vm-instantiation-file-(vns.vmmconfigfile)", 12354)
    ...
    prop._addConstant("vsanmgrEntity", "vsan-manager-entity-(vsanmgr.entity)", 8445)
    prop._addConstant("vsanmgrInst", "vsan-manager-instance-(vsanmgr.inst)", 8446)
    prop._addConstant("vzAnyDef", "to-fix---vz.anydef", 5642)
    prop._addConstant("vzAnyDefCont", "vzanydef-container-(vz.anydefcont)", 5641)
    prop._addConstant("vzAnyGroupDef", "to-fix---vz.anygroupdef", 9365)
