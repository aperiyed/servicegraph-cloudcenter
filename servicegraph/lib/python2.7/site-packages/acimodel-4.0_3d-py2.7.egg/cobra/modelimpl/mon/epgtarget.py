...
class EPGTarget(Mo):
    ...
    prop._addConstant("dbgacRsFromAbsEpg", "source-epg-relation-for-atomic-counter-policy-(dbgac.rsfromabsepg)", 6262)
    ...
    prop._addConstant("dbgacRsFromLDevForExtToEp", "source-ldev-relation-for-end-point-to-ext.-ip-address-atomic-counter-policy-(dbgac.rsfromldevforexttoep)", 4102)
    ...
    prop._addConstant("dbgacRsToAbsEpg", "destination-epg-relation-for-atomic-counter-policy-(dbgac.rstoabsepg)", 6264)
    prop._addConstant("dbgacRsToAbsEpgForEpgToEpg", "destination-epg-relation-for-atomic-counter-policy-(dbgac.rstoabsepgforepgtoepg)", 11261)
    ...
    prop._addConstant("fvAEPgLagPolAtt", "to-fix---fv.aepglagpolatt", 13009)
    ...
    prop._addConstant("fvRsBd", "bridge-domain-(fv.rsbd)", 1988)
    ...
    prop._addConstant("vnsEPgDefCons", "to-fix---vns.epgdefcons", 5963)
    ...
    prop._addConstant("vnsHealthDest", "to-fix---vns.healthdest", 12352)
    ...
    prop._addConstant("vnsRsLIfCtxToSvcEPgPol", "to-fix---vns.rslifctxtosvcepgpol", 12987)
    prop._addConstant("vnsRsLIfCtxToSvcRedirectPol", "to-fix---vns.rslifctxtosvcredirectpol", 7079)
    ...
    prop._addConstant("vnsSvcCont", "to-fix---vns.svccont", 7081)
    prop._addConstant("vnsSvcEPgPol", "to-fix---vns.svcepgpol", 12989)
    prop._addConstant("vnsSvcPol", "l4-l7-policy-container-(vns.svcpol)", 11021)
    prop._addConstant("vnsSvcRedirectPol", "to-fix---vns.svcredirectpol", 7082)
    ...
    prop._addConstant("vzCollectionDef", "to-fix---vz.collectiondef", 1374)
    prop._addConstant("vzConsDef", "consumer-epg-(vz.consdef)", 1401)
    prop._addConstant("vzCtrctEPgCont", "to-fix---vz.ctrctepgcont", 1378)
