...
class InfraTarget(Mo):
    ...
    prop._addConstant("compMigratingVm", "pointer-to-migrating-vm-(comp.migratingvm)", 12950)
    ...
    prop._addConstant("compTagCont", "to-fix---comp.tagcont", 9854)
    ...
    prop._addConstant("edmRsEncapDef", "external-device-manager-encap-definition-(edm.rsencapdef)", 12658)
    ...
    prop._addConstant("vmmEpValidatorPol", "to-fix---vmm.epvalidatorpol", 7944)
