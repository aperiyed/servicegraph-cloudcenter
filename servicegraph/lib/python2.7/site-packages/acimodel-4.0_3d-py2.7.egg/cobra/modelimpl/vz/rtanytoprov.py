...
# ##################################################
class RtAnyToProv(Mo):
    """
    A target relation to any provider.

    """

    meta = TargetRelationMeta("cobra.model.vz.RtAnyToProv", "cobra.model.vz.Any")

    meta.moClassName = "vzRtAnyToProv"
    meta.rnFormat = "rtanyToProv-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 11890, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11889, PropCategory.REGULAR)
