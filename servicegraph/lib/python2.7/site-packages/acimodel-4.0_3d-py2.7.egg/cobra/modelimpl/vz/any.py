...
class Any(Mo):
    ...
    meta = ClassMeta("cobra.model.vz.Any")

    meta.moClassName = "vzAny"
    meta.rnFormat = "any"
    meta.category = MoCategory.REGULAR
    meta.label = "Any"
    meta.writeAccessMask = 0x2001
    meta.readAccessMask = 0x2000000000002701
    ...
    meta.childClasses.add("cobra.model.vz.RtTermToAny")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.vz.RsAnyToCons")
    meta.childClasses.add("cobra.model.vz.ProvCtrctLbl")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.vz.RsAnyToConsIf")
    meta.childClasses.add("cobra.model.vz.RsAnyToProv")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RtTermToAny", "rtvnsTermToAny-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RsAnyToConsIf", "rsanyToConsIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.ConsSubjLbl", "conssubjlbl-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RsAnyToCons", "rsanyToCons-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.RsAnyToProv", "rsanyToProv-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37484, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configSt", "configSt", 1054, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39623, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "matchT", "matchT", 1053, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14090, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pcTag", "pcTag", 1052, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "prefGrMemb", "prefGrMemb", 27674, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "txId", "txId", 51772, PropCategory.REGULAR)
    prop.label = "Transaction Id when vzAny was created"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "useAnyDef", "useAnyDef", 16602, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
