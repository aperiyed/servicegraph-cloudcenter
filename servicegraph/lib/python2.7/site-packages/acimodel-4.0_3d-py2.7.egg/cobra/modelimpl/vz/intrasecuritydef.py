...
# ##################################################
class IntraSecurityDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vz.IntraSecurityDef")

    meta.moClassName = "vzIntraSecurityDef"
    meta.rnFormat = "intra-[%(epgDn)s]-any-%(isAny)s"
    meta.category = MoCategory.REGULAR
    meta.label = "EPg with Intra EPg security enabled"
    ...
    prop = PropMeta("str", "epgDn", "epgDn", 33376, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "isAny", "isAny", 33375, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 33378, PropCategory.REGULAR)
