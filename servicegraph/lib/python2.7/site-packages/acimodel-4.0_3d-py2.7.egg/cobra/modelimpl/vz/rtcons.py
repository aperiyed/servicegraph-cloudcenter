...
class RtCons(Mo):
    """
    A target relation to a consumer. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vz.RtCons", "cobra.model.fv.EPg")

    meta.moClassName = "vzRtCons"
    meta.rnFormat = "rtfvCons-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12203, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12202, PropCategory.REGULAR)
