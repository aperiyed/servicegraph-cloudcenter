...
class RtProtBy(Mo):
    """
    A target relation to a taboo contract. A taboo contract provides a way for an endpoint group to specify the subjects on which communication is not allowed. Note that this relation is an internal object.

    """

    meta = TargetRelationMeta("cobra.model.vz.RtProtBy", "cobra.model.fv.EPg")

    meta.moClassName = "vzRtProtBy"
    meta.rnFormat = "rtfvProtBy-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 12234, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 12233, PropCategory.REGULAR)
