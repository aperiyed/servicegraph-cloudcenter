...
class RsIf(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vz.RsIf", "cobra.model.vz.ACtrct")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vzRsIf"
    meta.rnFormat = "rsif"
    ...
    meta.superClasses.add("cobra.model.vz.InterfaceToCollection")

    meta.rnPrefixes = [
        ('rsif', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 37466, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39605, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14076, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "prio", "prio", 11816, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 9)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 11815, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1298
    prop.defaultValueStr = "vzACtrct"
    prop._addConstant("unspecified", "unspecified", 0)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11814, PropCategory.REGULAR)
