...
class RsRFltAtt(Mo):
    """
    A source relation to a resolved filter profile.

    """

    meta = SourceRelationMeta("cobra.model.vz.RsRFltAtt", "cobra.model.vz.AFilterableUnit")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vzRsRFltAtt"
    ...
    meta.childClasses.add("cobra.model.vns.AdjacencyDefCont")
    meta.childClasses.add("cobra.model.vns.CopyAdjacencyDef")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.AdjacencyDefCont", "adjCont-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vz.CreatedBy", "by-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.CopyAdjacencyDef", "bd-"))
    ...
    prop = PropMeta("str", "action", "action", 11927, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "direction", "direction", 11929, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "isGraph", "isGraph", 15352, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "markDscp", "markDscp", 11930, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 21494, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "prio", "prio", 11931, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 9)]
    ...
    prop = PropMeta("str", "priorityOverride", "priorityOverride", 37170, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8
    prop.defaultValueStr = "default"
    prop._addConstant("default", "inherit-level", 8)
    prop._addConstant("level1", "lowest-priority", 4)
    prop._addConstant("level2", "medium-priority", 2)
    prop._addConstant("level3", "highest-priority", 1)
    ...
    prop = PropMeta("str", "remoteMarkDscp", "remoteMarkDscp", 20338, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop._addConstant("VA", "voice-admit", 44)
    prop._addConstant("unspecified", "unspecified", 64)
    meta.props.add("remoteMarkDscp", prop)

    prop = PropMeta("str", "remotePrio", "remotePrio", 21045, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 9)]
    ...
    prop._addConstant("level6", "level6", 7)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("remotePrio", prop)
    ...
    prop = PropMeta("str", "tCl", "tCl", 11926, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 11925, PropCategory.REGULAR)
