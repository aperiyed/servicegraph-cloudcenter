...
# ##################################################
class RsAnyToProv(Mo):
    """
    A source relation to a binary contract profile.

    """

    meta = NamedSourceRelationMeta("cobra.model.vz.RsAnyToProv", "cobra.model.vz.BrCP")
    meta.targetNameProps["name"] = "tnVzBrCPName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vzRsAnyToProv"
    meta.rnFormat = "rsanyToProv-%(tnVzBrCPName)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 37485, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39624, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "matchT", "matchT", 11887, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14091, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "prio", "prio", 11888, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 9)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 11886, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnVzBrCPName", "tnVzBrCPName", 11885, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
