...
# ##################################################
class MigratingVmTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.MigratingVmTask")

    meta.moClassName = "compMigratingVmTask"
    meta.rnFormat = "compMigratingVmTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 44667, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("VerifyMigratingVm", "verifymigratingvm", 3223)
