...
class Hv(Mo):
    """
    The compute hypervisor.

    """

    meta = ClassMeta("cobra.model.comp.Hv")

    meta.moClassName = "compHv"
    meta.rnFormat = "hv-%(oid)s"
    ...
    meta.childClasses.add("cobra.model.comp.HvHealth")
    ...
    meta.childClasses.add("cobra.model.comp.SvmNicInfo")
    ...
    meta.childClasses.add("cobra.model.comp.MgmtNic")
    meta.childClasses.add("cobra.model.comp.TrnsmtdPkts1mo")
    meta.childClasses.add("cobra.model.comp.RtRpToHost")
    ...
    meta.childClasses.add("cobra.model.comp.HpNic")
    meta.childClasses.add("cobra.model.comp.RtHv")
    ...
    meta.childClasses.add("cobra.model.hvs.VNode")
    ...
    meta.childClasses.add("cobra.model.comp.RtCompHv")
    ...
    meta.childClasses.add("cobra.model.comp.RsHealthDef")
    ...
    meta.childClasses.add("cobra.model.comp.RtVNodeToHv")
    ...
    meta.childClasses.add("cobra.model.comp.RtOpflexHv")
    ...
    meta.childClasses.add("cobra.model.hvs.Adj")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtVNodeToHv", "rtfvVNodeToHv-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsNestedInVm", "rsnestedInVm"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsHealthDef", "rshealthDef"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtRpToHost", "rtRpToHost"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtHyper", "rtfvHyper-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtOpflexHv", "rtopflexHv"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HvHealth", "hvHealth"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.MgmtNic", "mgmtnic-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtCompHv", "rtcompHv"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.LabelVal", "lblval-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HpNic", "hpnic-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsPhys", "rsphys"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtHv", "rthv-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.SvmNicInfo", "svm-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.Adj", "adj-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.VNode", "sw-"))
    ...
    prop = PropMeta("str", "availAdminSt", "availAdminSt", 44735, PropCategory.REGULAR)
    prop.label = "None"
    ...
    meta.props.add("availAdminSt", prop)

    prop = PropMeta("str", "availOperSt", "availOperSt", 44736, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop._addConstant("red", "red", 2)
    prop._addConstant("yellow", "yellow", 3)
    meta.props.add("availOperSt", prop)
    ...
    prop = PropMeta("str", "countUplink", "countUplink", 1041, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("countUplink", prop)
    ...
    prop = PropMeta("str", "enteringMaintenance", "enteringMaintenance", 44734, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("enteringMaintenance", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 14068, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "oid", "oid", 5918, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "operIssues", "operIssues", 27058, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 1040, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 3
